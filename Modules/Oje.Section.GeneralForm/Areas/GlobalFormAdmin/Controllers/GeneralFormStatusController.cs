...
namespace Oje.Section.GlobalForms.Areas.GlobalFormAdmin.Controllers
{
    ...
    [AreaConfig(ModualTitle = "فرم های عمومی", Icon = "fa-file-powerpoint", Title = "وضعیت فرم عمومی")]
    ...
    public class GeneralFormStatusController: Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            ViewBag.ConfigRoute = Url.Action("GetJsonConfig", "GeneralFormStatus", new { area = "GlobalFormAdmin" });
            return View();
        }
        ...
        public IActionResult GetJsonConfig()
        {
            ...
            return Content(System.IO.File.ReadAllText(GlobalConfig.GetJsonConfigFile("GlobalFormAdmin", "GeneralFormStatus")));
        }
