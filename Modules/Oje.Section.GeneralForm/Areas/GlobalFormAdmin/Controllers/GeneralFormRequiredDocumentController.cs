...
namespace Oje.Section.GlobalForms.Areas.GlobalFormAdmin.Controllers
{
    ...
    [AreaConfig(ModualTitle = "فرم های عمومی", Icon = "fa-file-powerpoint", Title = "مدارک مورد نیاز فرم عمومی")]
    ...
    public class GeneralFormRequiredDocumentController: Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            ViewBag.ConfigRoute = Url.Action("GetJsonConfig", "GeneralFormRequiredDocument", new { area = "GlobalFormAdmin" });
            return View();
        }
        ...
        public IActionResult GetJsonConfig()
        {
            ...
            return Content(System.IO.File.ReadAllText(GlobalConfig.GetJsonConfigFile("GlobalFormAdmin", "GeneralFormRequiredDocument")));
        }
