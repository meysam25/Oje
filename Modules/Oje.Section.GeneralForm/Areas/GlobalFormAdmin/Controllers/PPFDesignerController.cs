...
namespace Oje.Section.GlobalForms.Areas.GlobalFormAdmin.Controllers
{
    ...
    [AreaConfig(ModualTitle = "فرم های عمومی", Icon = "fa-file-powerpoint", Title = "طراحی فرم")]
    ...
    public class PPFDesignerController: Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            ViewBag.ConfigRoute = Url.Action("GetJsonConfig", "PPFDesigner", new { area = "GlobalFormAdmin" });
            return View();
        }
        ...
        public IActionResult GetJsonConfig()
        {
            ...
            return Content(System.IO.File.ReadAllText(GlobalConfig.GetJsonConfigFile("GlobalFormAdmin", "PPFDesigner")));
        }
