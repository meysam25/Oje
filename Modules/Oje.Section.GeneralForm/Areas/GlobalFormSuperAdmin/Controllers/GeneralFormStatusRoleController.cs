...
namespace Oje.Section.GlobalForms.Areas.GlobalFormSuperAdmin.Controllers
{
    ...
    [AreaConfig(ModualTitle = "پایه فرم های عمومی", Icon = "fa-file-powerpoint", Title = "دسترسی فرم عمومی")]
    ...
    public class GeneralFormStatusRoleController : Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            ViewBag.ConfigRoute = Url.Action("GetJsonConfig", "GeneralFormStatusRole", new { area = "GlobalFormSuperAdmin" });
            return View();
        }
        ...
        public IActionResult GetJsonConfig()
        {
            ...
            return Content(System.IO.File.ReadAllText(GlobalConfig.GetJsonConfigFile("GlobalFormSuperAdmin", "GeneralFormStatusRole")));
        }
