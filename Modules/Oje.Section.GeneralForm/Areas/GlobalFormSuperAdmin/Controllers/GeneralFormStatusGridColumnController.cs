...
namespace Oje.Section.GlobalForms.Areas.GlobalFormSuperAdmin.Controllers
{
    ...
    [AreaConfig(ModualTitle = "پایه فرم های عمومی", Icon = "fa-file-powerpoint", Title = "ستون های اضافی")]
    ...
    public class GeneralFormStatusGridColumnController : Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            ViewBag.ConfigRoute = Url.Action("GetJsonConfig", "GeneralFormStatusGridColumn", new { area = "GlobalFormSuperAdmin" });
            return View();
        }
        ...
        public IActionResult GetJsonConfig()
        {
            ...
            return Content(System.IO.File.ReadAllText(GlobalConfig.GetJsonConfigFile("GlobalFormSuperAdmin", "GeneralFormStatusGridColumn")));
        }
