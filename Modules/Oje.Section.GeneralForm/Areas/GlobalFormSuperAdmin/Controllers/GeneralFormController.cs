...
namespace Oje.Section.GlobalForms.Areas.GlobalFormSuperAdmin.Controllers
{
    ...
    [AreaConfig(ModualTitle = "پایه فرم های عمومی", Icon = "fa-file-powerpoint", Title = "فرم عمومی")]
    ...
    public class GeneralFormController : Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            ViewBag.ConfigRoute = Url.Action("GetJsonConfig", "GeneralForm", new { area = "GlobalFormSuperAdmin" });
            return View();
        }
        ...
        public IActionResult GetJsonConfig()
        {
            ...
            return Content(System.IO.File.ReadAllText(GlobalConfig.GetJsonConfigFile("GlobalFormSuperAdmin", "GeneralForm")));
        }
