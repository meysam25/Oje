...
namespace Oje.Section.CarThirdBaseData.Areas.CarThirdBaseData.Controllers
{
    ...
    [AreaConfig(ModualTitle = " پایه استعلام ثالث خودرو (ادمین)", Icon = "fa-car-side", Title = "سرمایه بیمه ثالث")]
    ...
    public class ThirdPartyRateController: Controller
    {
        ...
        {
            return Json(ThirdPartyRateManager.Create(input));
        }
        ...
        {
            return Json(ThirdPartyRateManager.Delete(input?.id));
        }
        ...
        {
            return Json(ThirdPartyRateManager.GetById(input?.id));
        }
        ...
        {
            return Json(ThirdPartyRateManager.Update(input));
        }
        ...
        {
            return Json(ThirdPartyRateManager.GetList(searchInput));
        }
        ...
        {
            var result = ThirdPartyRateManager.GetList(searchInput);
