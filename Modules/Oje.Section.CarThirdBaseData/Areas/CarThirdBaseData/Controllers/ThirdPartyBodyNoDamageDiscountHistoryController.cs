...
namespace Oje.Section.CarThirdBaseData.Areas.CarThirdBaseData.Controllers
{
    ...
    public class ThirdPartyBodyNoDamageDiscountHistoryController: Controller
    {
        ...
        {
            return Json(ThirdPartyBodyNoDamageDiscountHistoryManager.Create(input));
        }
        ...
        {
            return Json(ThirdPartyBodyNoDamageDiscountHistoryManager.Delete(input?.id));
        }
        ...
        {
            return Json(ThirdPartyBodyNoDamageDiscountHistoryManager.GetById(input?.id));
        }
        ...
        {
            return Json(ThirdPartyBodyNoDamageDiscountHistoryManager.Update(input));
        }
        ...
        {
            return Json(ThirdPartyBodyNoDamageDiscountHistoryManager.GetList(searchInput));
        }
        ...
        {
            var result = ThirdPartyBodyNoDamageDiscountHistoryManager.GetList(searchInput);
