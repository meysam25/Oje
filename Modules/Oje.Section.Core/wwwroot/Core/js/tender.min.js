...
`),i}function showRightNavRegButtons(n){var i,t,u,r;if($(".navigationButtonRoute").html(""),registerConfig)for(i=registerConfig.length-1;i>=0;i--)if(t=registerConfig[i],t.childs&&(u=t.childs.filter(function(t){return t.key==n}),u&&u.length>0))for(r=0;r<t.childs.length;r++)$(".navigationButtonRoute").append(getRightNavigationButtonTemplate(t.childs[r],n));$(".navigationButtonRoute").find(".navigationButton").click(function(){showRegisterForm($(this).attr("data-id"))})}function initContactUsButton(){$(".contactUsButton").click(function(){$(".mySlider").parent().hide();showLoader($(".mainContent"));postForm("/ContactUs",new FormData,function(n){var t=$(".mainContentBodyScroll");t.length>0&&(t.html('<div class="makeCenterContentForCC"><\/div>'),n.title&&$(".rightSectionTitleHodler .title").html(n.title),n.subTitle&&$(".rightSectionTitleHodler .subTitle").html(n.subTitle),loadJsonConfig("/ContactUs/GetJsonConfig",$(".makeCenterContentForCC")))},null,function(){hideLoader($(".mainContent"))},null,"GET",{Platform:"mobile"})})}function initAboutUsButton(){$(".aboutUsButton").click(function(){var n=$(this).attr("data-url");n&&($(".mySlider").parent().hide(),showLoader($(".mainContent")),postForm(n+"?ignoreL=true",new FormData,function(n){var t=$(".mainContentBodyScroll");t.length>0&&(t.html(n),t.find("[data-src]").each(function(){$(this).attr("src",$(this).attr("data-src"))}))},null,function(){hideLoader($(".mainContent"))},null,"GET"))})}function initLicenceButton(){$(".licenceButton").click(function(){var n=$(".mainContentBodyScroll");n.length>0&&(n.html('<div class="holderLicences" ><\/div>'),n=n.find(".holderLicences"),$(".mySlider").parent().hide(),showLoader($(".mainContent")),postForm("/Home/GetFooterSambole",new FormData,function(t){n.append(t&&t.enamad?'<div class="holderLicenceDiv" >'+t.enamad+"<\/div>":"");n.append(t&&t.samandehi?'<div class="holderLicenceDiv" >'+t.samandehi+"<\/div>":"");n.find("img[data-src]").loadImageOnScroll();postForm("/Home/GetTopLeftIconList",new FormData,function(t){if(hideLoader($(".mainContent")),t){var i="";t.mainFile1_address&&t.title1&&(i+=addTopLeftIcons(t.title1,t.mainFile1_address,t.description1,!0));t.mainFile2_address&&t.title2&&(i+=addTopLeftIcons(t.title2,t.mainFile2_address,t.description2));t.mainFile3_address&&t.title3&&(i+=addTopLeftIcons(t.title3,t.mainFile3_address,t.description3));n.append(i);$(".mainHeaderIranLogo,.mainHeaderElectronDevelopLogo").each(function(){var i=$(this).attr("title"),t=$(this).attr("data-des"),n;t&&(n={id:uuidv4RemoveDash(),title:i,modelBody:t,"class":"makeImage100",actions:[{title:"متوجه شدم",onClick:"closeThisModal(this)","class":"btn-secondary"}]},$(this).attr("data-modal-id",n.id),$(".mainContent").append(getModualTemplate(n)))});$(".mainHeaderIranLogo[data-des],.mainHeaderElectronDevelopLogo[data-des]").click(function(){var n=$(this).attr("data-modal-id");$("#"+n).modal("show")})}},null,null,null,"GET");n.find("a[href]").click(function(n){return n.stopPropagation(),n.preventDefault(),openModal($(this).attr("href"),$(this).text()),!1});n.find("img[onclick]").each(function(){$(this).attr("data-onclick",$(this).attr("onclick"));$(this).removeAttr("onclick")});n.find("img[data-onclick]").click(function(n){var i,t;return n.stopPropagation(),n.preventDefault(),i=$(this).attr("data-onclick"),i&&i.indexOf("window.open(")>-1&&(t=i.split("window.open(")[1],t.indexOf('"')>-1?t=t.split('"')[1]:t.indexOf("'")>-1&&(t=t.split("'")[1]),openModal(t,$(this).attr("alt"))),!1})},null,null,null,"GET"))})}function addTopLeftIcons(n,t,i,r){return'<div class="holderLicenceDiv"><img '+(i?'style="cursor:pointer"':"")+'  class="'+(r?"mainHeaderIranLogo":"mainHeaderElectronDevelopLogo")+'" title="'+n+'" src="'+t+'"  '+(i?"data-des='"+i+"'":"")+" /><div>"}function initStartButton(){$(".startButton").click(function(){$(".mainContentBodyScroll").html('<div class="fgSection"><\/div>');$(".fgSection").loadLoginPanel("/TenderWeb/GetLoginConfig",addRegisterButton);$(".mySlider").parent().hide()})}function getReminderTemplate(){return`
