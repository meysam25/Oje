...
`),t}function getRightNavigationButtonTemplate(n,t){var i="";return n&&(i=`
            <div data-id="${n.key}" class="navigationButton ${n.key==t?"navigationButtonActive":""}">
                <div>${n.value}</div>
            </div>
`),i}function showRightNavRegButtons(n){var i,t,u,r;if($(".navigationButtonRoute").html(""),registerConfig)for(i=registerConfig.length-1;i>=0;i--)if(t=registerConfig[i],t.childs&&(u=t.childs.filter(function(t){return t.key==n}),u&&u.length>0))for(r=0;r<t.childs.length;r++)$(".navigationButtonRoute").append(getRightNavigationButtonTemplate(t.childs[r],n));$(".navigationButtonRoute").find(".navigationButton").click(function(){showRegisterForm($(this).attr("data-id"))})}function initContactUsButton(){$(".contactUsButton").click(function(){$(".mySlider").parent().hide();showLoader($(".mainContent"));postForm("/ContactUs",new FormData,function(n){var t=$(".mainContentBodyScroll");t.length>0&&(t.html('<div class="makeCenterContentForCC aboutUsSectionFixMapProblem"><\/div>'),loadJsonConfig("/ContactUs/GetJsonConfig",$(".makeCenterContentForCC"),function(){n.subTitle&&t.find(".makeCenterContentForCC").prepend('<h4 class="aboutUsSubTitle" >'+n.subTitle+"<\/h3>");n.title&&t.find(".makeCenterContentForCC").prepend('<h3 class="aboutUsTitle" >'+n.title+"<\/h3>")}))},null,function(){hideLoader($(".mainContent"))},null,"GET",{Platform:"mobile"})})}function initAboutUsButton(){$(".aboutUsButton").click(function(){var n=$(this).attr("data-url");n&&($(".mySlider").parent().hide(),showLoader($(".mainContent")),postForm(n+"?ignoreL=true",new FormData,function(n){var t=$(".mainContentBodyScroll");t.length>0&&(t.html(n),t.find("[data-src]").each(function(){$(this).attr("src",$(this).attr("data-src"))}))},null,function(){hideLoader($(".mainContent"))},null,"GET"))})}function initLicenceButton(){$(".licenceButton").click(function(){loadLicenceF($(".mainContentBodyScroll"))})}function loadLicenceF(n){var t=n;t.length>0&&(t.html('<div class="holderLicences" ><\/div>'),t=t.find(".holderLicences"),showLoader($(".mainContent")),postForm("/Home/GetFooterSambole",new FormData,function(n){t.append(n&&n.enamad?'<div class="holderLicenceDiv" >'+n.enamad+"<\/div>":"");t.append(n&&n.samandehi?'<div class="holderLicenceDiv" >'+n.samandehi+"<\/div>":"");t.find("img[data-src]").loadImageOnScroll();postForm("/Home/GetTopLeftIconList",new FormData,function(n){if(hideLoader($(".mainContent")),n){var i="";n.mainFile1_address&&n.title1&&(i+=addTopLeftIcons(n.title1,n.mainFile1_address,n.description1,!0));n.mainFile2_address&&n.title2&&(i+=addTopLeftIcons(n.title2,n.mainFile2_address,n.description2));n.mainFile3_address&&n.title3&&(i+=addTopLeftIcons(n.title3,n.mainFile3_address,n.description3));t.prepend(i);t.find(".mainHeaderIranLogo,.mainHeaderElectronDevelopLogo").each(function(){var i=$(this).attr("title"),t=$(this).attr("data-des"),n;t&&(n={id:uuidv4RemoveDash(),title:i,modelBody:t,"class":"makeImage100",actions:[{title:"متوجه شدم",onClick:"closeThisModal(this)","class":"btn-secondary"}]},$(this).attr("data-modal-id",n.id),$(".mainContent").append(getModualTemplate(n)))});t.find(".mainHeaderIranLogo[data-des],.mainHeaderElectronDevelopLogo[data-des]").click(function(){var n=$(this).attr("data-modal-id");$("#"+n).modal("show")})}},null,null,null,"GET");t.find("a[href]").click(function(n){return n.stopPropagation(),n.preventDefault(),openModal($(this).attr("href"),$(this).text()),!1});t.find("img[onclick]").each(function(){$(this).attr("data-onclick",$(this).attr("onclick"));$(this).removeAttr("onclick")});t.find("img[data-onclick]").click(function(n){var i,t;return n.stopPropagation(),n.preventDefault(),i=$(this).attr("data-onclick"),i&&i.indexOf("window.open(")>-1&&(t=i.split("window.open(")[1],t.indexOf('"')>-1?t=t.split('"')[1]:t.indexOf("'")>-1&&(t=t.split("'")[1]),openModal(t,$(this).attr("alt"))),!1})},null,null,null,"GET"))}function addTopLeftIcons(n,t,i,r){return'<div class="holderLicenceDiv"><img '+(i?'style="cursor:pointer"':"")+'  class="'+(r?"mainHeaderIranLogo":"mainHeaderElectronDevelopLogo")+'" title="'+n+'" src="'+t+'"  '+(i?"data-des='"+i+"'":"")+" /><\/div>"}function initStartButton(){$(".startButton").click(function(){$(".loginModalHolder").remove();var n=uuidv4RemoveDash();$("body").append('<div class="loginModalHolder" id="'+n+'" ><\/div>');showLoader($("body"));loadJsonConfig("/TenderWeb/GetLoginConfig",n,function(){$("#loginForgetPasswordModal").modal("show");initWhatToDoLogin();hideLoader($("body"))})})}function getReminderTemplate(){return`
...
`}function initReminderButton(){$(".reminderButton").click(function(){showLoader($(".mainContentBody"));$(".mainContentBodyScroll").html('<div class="makeCenterContentForCC">'+getReminderTemplate()+"<\/div>");loadJsonConfig("/Home/GetReminderConfig",$("#reminderSection .reminderSectionInput"),function(){$("#reminderSection").loadAndBindRemindUsSection("/Reminder/GetMainPageDescription",function(){hideLoader($(".mainContentBody"))})},"GET")})}function hideAllButtonAndJustShowHomeButton(){$(".showLoginModal").css("display","none");$(".moveToHome").css("display","block")}function loadOurPrice(){var n=$(".fgSection");n.length>0&&(n.html(`
