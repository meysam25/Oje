...
(function ($) {
        ...
        init: function (options) {
            ...
            return this.each(function () {
                ...
                $this.popover({
                    ...
                    title: 'انتخاب تاریخ',
                    trigger: 'manual',
                    template: '<div class="popover" role="tooltip"><div class="arrow"></div><h3 class="popover-header" data-name="Md-DateTimePicker-Title"></h3><div class="popover-body"  data-name="Md-DateTimePicker-PopoverContent"></div></div>',
    ...
    $('html').on('click', function (e) {
        ...
        if ($target && $target.closest('.popover').length == 0 && // اگر روی تقویم کلیک نشده بود
            !hasFlag  // اگر فلگ نداشت
            ) // اگر روی تقویم کلیک نشده بود
        {
