...
namespace Oje.Section.Account.Areas.UserAccount.Controllers
{
    ...
    [AreaConfig(ModualTitle = "حساب کاربری", Icon = "fa-users", Title = "پیام")]
    ...
    public class UserMessageController : Controller
    {
        ...
        {
            ViewBag.Title = "پیام";
            ViewBag.ConfigRoute = Url.Action("GetJsonConfig", "UserMessage", new { area = "UserAccount" });
            return View();
        }
        ...
        public IActionResult GetJsonConfig()
        {
            ...
            return Content(System.IO.File.ReadAllText(GlobalConfig.GetJsonConfigFile("UserAccount", "UserMessage")));
        }
