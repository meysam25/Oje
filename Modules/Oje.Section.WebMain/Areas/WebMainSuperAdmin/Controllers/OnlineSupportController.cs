...
namespace Oje.Section.WebMain.Areas.WebMainSuperAdmin.Controllers
{
    ...
    [AreaConfig(ModualTitle = "مدیریت وب سایت", Order = 3, Icon = "fa-browser", Title = "پشتیبانی آنلاین")]
    ...
    public class OnlineSupportController : Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            ViewBag.ConfigRoute = Url.Action("GetJsonConfig", "OnlineSupport", new { area = "WebMainSuperAdmin" });
            return View();
        }
        ...
        public IActionResult GetJsonConfig()
        {
            ...
            return Content(System.IO.File.ReadAllText(GlobalConfig.GetJsonConfigFile("WebMainSuperAdmin", "OnlineSupport")));
        }
