...
namespace Oje.Section.WebMain.Areas.WebMainAdmin.Controllers
{
    ...
    [AreaConfig(ModualTitle = "تنظیمات وب سایت", Icon = "fa-browser", Title = "یادآوری صفحه اصلی")]
    ...
    public class ReminderMainPageController : Controller
    {
        ...
        {
            return Json(PropertyService.Delete(PropertyType.RemindUsMainPage, SiteSettingService.GetSiteSetting()?.Id, key));
        }
    }
}
