...
namespace Oje.Section.WebMain.Areas.WebMainAdmin.Controllers
{
    ...
    [AreaConfig(ModualTitle = "تنظیمات وب سایت", Icon = "fa-browser", Title = "افتخارات ما صفحه اصلی")]
    ...
    public class OurPrideController : Controller
    {
        ...
        {
            return Json(PropertyService.Delete(PropertyType.OurPrideMainPage, SiteSettingService.GetSiteSetting()?.Id, key));
        }
    }
}
