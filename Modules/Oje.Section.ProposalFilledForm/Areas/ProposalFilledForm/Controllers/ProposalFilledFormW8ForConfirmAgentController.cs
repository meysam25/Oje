...
namespace Oje.Section.ProposalFilledForm.Areas.ProposalFilledForm.Controllers
{
    ...
    public class ProposalFilledFormW8ForConfirmAgentController : Controller
    {
        ...
        [AreaConfig(Title = "مشاهده شرکت تایین قیمت فرم پیشنهاد در انتظار تایید نماینده", Icon = "fa-eye")]
        [HttpPost]
        ...
        [AreaConfig(Title = "مشاهده لیست تایین قیمت فرم پیشنهاد در انتظار تایید نماینده", Icon = "fa-eye")]
        [HttpPost]
        ...
        [AreaConfig(Title = "ایجاد مدرک مالی فرم پیشنهاد در انتظار تایید نماینده", Icon = "fa-trash-o")]
        [HttpPost]
        ...
        [AreaConfig(Title = "ایجاد مدرک مالی فرم پیشنهاد در انتظار تایید نماینده", Icon = "fa-pencil")]
        [HttpPost]
