...
namespace Oje.Section.ProposalFilledForm.Areas.ProposalFilledForm.Controllers
{
    ...
    [AreaConfig(ModualTitle = "مدیریت بیمه نامه ها", Order = 12,  Icon = "fa-file-powerpoint", Title = "پیشنهاد در انتظار تایید")]
    [CustomeAuthorizeFilter]
    public class ProposalFilledFormW8ForConfirmAgentController : Controller
    {
        ...
        public ProposalFilledFormW8ForConfirmAgentController(
        ...
        public IActionResult Index()
        {
            ...
            ViewBag.ConfigRoute = Url.Action("GetJsonConfig", "ProposalFilledFormW8ForConfirmAgent", new { area = "ProposalFilledForm" });
            return View();
        }
        ...
        public IActionResult GetJsonConfig()
        {
            ...
            return Content(System.IO.File.ReadAllText(GlobalConfig.GetJsonConfigFile("ProposalFilledForm", "ProposalFilledFormW8ForConfirmAgent")));
        }

        [AreaConfig(Title = "ویرایش فرم پیشنهاد در انتظار تایید نماینده", Icon = "fa-pen")]
        [HttpGet]
        public IActionResult Edit(int fid)
        {
            ViewBag.Title = "ویرایش فرم پیشنهاد در انتظار تایید نماینده";
            ViewBag.exteraParameters = new { fid = fid };
            ViewBag.ConfigRoute = Url.Action("GetEditJsonConfig", "ProposalFilledFormW8ForConfirmAgent", new { area = "ProposalFilledForm" });
            return View("Index");
        }

        [AreaConfig(Title = "تنظیمات صفحه ویرایش فرم پیشنهاد در انتظار تایید نماینده", Icon = "fa-cog")]
        [HttpPost]
        public IActionResult GetEditJsonConfig(int fid)
        {
            ...
            return Content(ProposalFilledFormAdminService.GetJsonConfir(
                    ...
                    Url.Action("GetById", "ProposalFilledFormW8ForConfirmAgent", new { area = "ProposalFilledForm", id = fid }),
                    Url.Action("Update", "ProposalFilledFormW8ForConfirmAgent", new { area = "ProposalFilledForm", id = fid })
                    )
                );
        }

        [AreaConfig(Title = "ذخیره جزییات فرم پیشنهاد در انتظار تایید نماینده", Icon = "fa-pencil")]
        [HttpPost]
        ...
        [AreaConfig(Title = "ذخیره ارجاع برای فرم پیشنهاد در انتظار تایید نماینده", Icon = "fa-pencil")]
        [HttpPost]
        ...
        [AreaConfig(Title = "تغییر نماینده فرم پیشنهاد در انتظار تایید نماینده", Icon = "fa-pencil")]
        [HttpPost]
        ...
        [AreaConfig(Title = "مشاهده جزییات فرم پیشنهاد در انتظار تایید نماینده", Icon = "fa-eye")]
        [HttpPost]
        ...
        [AreaConfig(Title = "حذف فرم پیشنهاد در انتظار تایید نماینده", Icon = "fa-trash-o")]
        [HttpPost]
        ...
        [AreaConfig(Title = "مشاهده وضعیت فرم پیشنهاد در انتظار تایید نماینده", Icon = "fa-eye")]
        [HttpPost]
        ...
        [AreaConfig(Title = "تغییر وضعیت فرم پیشنهاد در انتظار تایید نماینده", Icon = "fa-pencil")]
        [HttpPost]
        ...
        [AreaConfig(Title = "مشاهده لیست کاربران ارجاع داده شده فرم پیشنهاد در انتظار تایید نماینده", Icon = "fa-eye")]
        [HttpPost]
        ...
        [AreaConfig(Title = "مشاهده نماینده فرم پیشنهاد در انتظار تایید نماینده", Icon = "fa-eye")]
        [HttpPost]
        ...
        [AreaConfig(Title = "مشاهده لیست شرکت های فرم پیشنهاد در انتظار تایید نماینده", Icon = "fa-eye")]
        [HttpPost]
        ...
        [AreaConfig(Title = "به روز رسانی شرکت فرم پیشنهاد در انتظار تایید نماینده", Icon = "fa-pencil")]
        [HttpPost]
        ...
        [AreaConfig(Title = "افزودن شرکت فرم پیشنهاد در انتظار تایید نماینده", Icon = "fa-plus")]
        [HttpPost]
        ...
        [AreaConfig(Title = "ویرایش شرکت فرم پیشنهاد در انتظار تایید نماینده", Icon = "fa-pencil")]
        [HttpPost]
        ...
        [AreaConfig(Title = "دانلود پی دی اف فرم پیشنهاد در انتظار تایید نماینده", Icon = "fa-download")]
        [HttpGet]
        public IActionResult DownloadPdf([FromQuery] GlobalLongId input)
        {
            return File(
                    HtmlToPdfBlink.Convert((Request.IsHttps ? "https" : "http") + "://" + Request.Host + Url.Action("PdfDetailesForAdmin", "ProposalFilledFormW8ForConfirmAgent", new { area = "ProposalFilledForm", id = input.id, isPrint = true }), Request.Cookies),
                    System.Net.Mime.MediaTypeNames.Application.Pdf, DateTime.Now.ToFaDate("_") + "_" + DateTime.Now.ToString("HH_mm_ss") + ".pdf"
                );
        }

        [AreaConfig(Title = "مشاهده اسناد فرم پیشنهاد در انتظار تایید نماینده", Icon = "fa-eye")]
        [HttpPost]
        ...
        [AreaConfig(Title = "حذف اسناد فرم پیشنهاد در انتظار تایید نماینده", Icon = "fa-trash-o")]
        [HttpPost]
        ...
        [AreaConfig(Title = "افزودن اسناد فرم پیشنهاد در انتظار تایید نماینده", Icon = "fa-plus")]
        [HttpPost]
        ...
        [AreaConfig(Title = "جزییات فرم پیشنهاد در انتظار تایید نماینده", Icon = "fa-eye")]
        [HttpGet]
        ...
        [AreaConfig(Title = "مشاهده شرکت تعیین قیمت فرم پیشنهاد در انتظار تایید نماینده", Icon = "fa-eye")]
        [HttpPost]
        ...
        [AreaConfig(Title = "حذف شرکت فرم پیشنهاد در انتظار تایید نماینده", Icon = "fa-trash-o")]
        [HttpPost]
        ...
        [AreaConfig(Title = "انتخاب شرکت فرم پیشنهاد در انتظار تایید نماینده", Icon = "fa-pencil")]
        [HttpPost]
        ...
        [AreaConfig(Title = "مشاهده لیست تعیین قیمت فرم پیشنهاد در انتظار تایید نماینده", Icon = "fa-eye")]
        [HttpPost]
        ...
        [AreaConfig(Title = "مشاهده پیشنهاد در انتظار تایید نماینده", Icon = "fa-eye")]
        [HttpPost]
        public ActionResult GetList([FromForm] ProposalFilledFormMainGrid searchInput)
        {
            return Json(ProposalFilledFormAdminService.GetList(searchInput, SiteSettingService.GetSiteSetting()?.Id, HttpContext.GetLoginUser()?.UserId, ProposalFilledFormStatus.W8ForConfirm, HttpContext.GetLoginUser()?.roles));
        }

        [AreaConfig(Title = "خروجی اکسل فرم پیشنهاد در انتظار تایید نماینده", Icon = "fa-file-excel")]
        [HttpPost]
        ...
        [AreaConfig(Title = "حذف مدرک مالی فرم پیشنهاد در انتظار تایید نماینده", Icon = "fa-trash-o")]
        [HttpPost]
        ...
        [AreaConfig(Title = "ایجاد مدرک مالی فرم پیشنهاد در انتظار تایید نماینده", Icon = "fa-plus")]
        [HttpPost]
        ...
        [AreaConfig(Title = "به روز رسانی مدرک مالی فرم پیشنهاد در انتظار تایید نماینده", Icon = "fa-pencil")]
        [HttpPost]
        ...
        [AreaConfig(Title = "مشاهده مدرک مالی فرم پیشنهاد در انتظار تایید نماینده", Icon = "fa-eye")]
        [HttpPost]
        ...
        [AreaConfig(Title = "مشاهده لیست مدارک مالی فرم پیشنهاد در انتظار تایید نماینده", Icon = "fa-eye")]
        [HttpPost]
        ...
        [AreaConfig(Title = "خروجی اکسل مدارک مالی فرم پیشنهاد در انتظار تایید نماینده", Icon = "fa-file-excel")]
        [HttpPost]
        ...
        [AreaConfig(Title = "مشاهده لیست تاریخچه وضعیت فرم پیشنهاد در انتظار تایید نماینده", Icon = "fa-eye")]
        [HttpPost]
