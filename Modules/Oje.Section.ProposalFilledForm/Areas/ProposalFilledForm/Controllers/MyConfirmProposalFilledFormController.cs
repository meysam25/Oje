...
namespace Oje.Section.ProposalFilledForm.Areas.ProposalFilledForm.Controllers
{
    ...
    [AreaConfig(ModualTitle = "مدیریت بیمه نامه ها", Order = 7,  Icon = "fa-file-powerpoint", Title = "بیمه نامه های من (تایید شده)")]
    ...
    public class MyConfirmProposalFilledFormController: Controller
    {
        ...
        [AreaConfig(Title = "بیمه نامه های من (تایید شده)", Icon = "fa-badge-check", IsMainMenuItem = true)]
        [HttpGet]
        public IActionResult Index()
        {
            ViewBag.Title = "بیمه نامه های من (تایید شده)";
            ViewBag.ConfigRoute = Url.Action("GetJsonConfig", "MyConfirmProposalFilledForm", new { area = "ProposalFilledForm" });
            return View();
        }

        [AreaConfig(Title = "تنظیمات صفحه بیمه نامه های من (تایید شده)", Icon = "fa-cog")]
        [HttpPost]
        ...
        [AreaConfig(Title = "مشاهده بیمه نامه های من (تایید شده)", Icon = "fa-eye")]
        [HttpPost]
        ...
        [AreaConfig(Title = "مشاهده مدارک مالی بیمه نامه های من (تایید شده)", Icon = "fa-eye")]
        [HttpPost]
