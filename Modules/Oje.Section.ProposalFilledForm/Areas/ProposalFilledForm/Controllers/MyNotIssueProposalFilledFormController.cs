...
namespace Oje.Section.ProposalFilledForm.Areas.ProposalFilledForm.Controllers
{
    ...
    [AreaConfig(ModualTitle = "مدیریت بیمه نامه ها", Order = 12,  Icon = "fa-file-powerpoint", Title = "بیمه نامه های من (صادر نشده)")]
    ...
    public class MyNotIssueProposalFilledFormController: Controller
    {
        ...
        [AreaConfig(Title = "لیست بیمه نامه های من (صادر نشده)", Icon = "fa-book-dead", IsMainMenuItem = true)]
        [HttpGet]
        public IActionResult Index()
        {
            ViewBag.Title = "لیست بیمه نامه های من (صادر نشده)";
            ViewBag.ConfigRoute = Url.Action("GetJsonConfig", "MyNotIssueProposalFilledForm", new { area = "ProposalFilledForm" });
            return View();
        }

        [AreaConfig(Title = "تنظیمات صفحه لیست بیمه نامه های من (صادر نشده)", Icon = "fa-cog")]
        [HttpPost]
        ...
        [AreaConfig(Title = "دانلود پی دی اف بیمه نامه های من (صادر نشده)", Icon = "fa-download")]
        [HttpGet]
        ...
        [AreaConfig(Title = "جزییات بیمه نامه های من (صادر نشده)", Icon = "fa-eye")]
        [HttpGet]
        ...
        [AreaConfig(Title = "مشاهده لیست بیمه نامه های من (صادر نشده)", Icon = "fa-eye")]
        [HttpPost]
        ...
        [AreaConfig(Title = "مشاهده اسناد بیمه نامه های من (صادر نشده)", Icon = "fa-eye")]
        [HttpPost]
        ...
        [AreaConfig(Title = "افزودن اسناد بیمه نامه های من (صادر نشده)", Icon = "fa-plus")]
        [HttpPost]
        ...
        [AreaConfig(Title = "مشاهده لیست مدارک مالی بیمه نامه های من (صادر نشده)", Icon = "fa-eye")]
        [HttpPost]
