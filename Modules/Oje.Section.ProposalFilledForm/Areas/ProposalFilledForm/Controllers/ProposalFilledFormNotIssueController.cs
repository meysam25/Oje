...
namespace Oje.Section.ProposalFilledForm.Areas.ProposalFilledForm.Controllers
{
    ...
    public class ProposalFilledFormNotIssueController : Controller
    {
        ...
        [AreaConfig(Title = "مشاهده شرکت تعیین قیمت فرم پیشنهاد رد شده", Icon = "fa-eye")]
        [HttpPost]
        ...
        [AreaConfig(Title = "مشاهده لیست تعیین قیمت فرم پیشنهاد رد شده", Icon = "fa-eye")]
        [HttpPost]
        ...
        [AreaConfig(Title = "مشاهده پیشنهاد رد شده", Icon = "fa-eye")]
        [HttpPost]
