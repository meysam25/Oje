...
namespace Oje.Section.ProposalFilledForm.Areas.ProposalFilledForm.Controllers
{
    ...
    [AreaConfig(ModualTitle = "فرم های پیشنهاد", Icon = "fa-file-powerpoint", Title = " پیشنهاد تایید شده")]
    [CustomeAuthorizeFilter]
    public class ProposalFilledFormConfirmAgentController: Controller
    {
        ...
        public ProposalFilledFormConfirmAgentController(
        ...
        public IActionResult Index()
        {
            ...
            ViewBag.ConfigRoute = Url.Action("GetJsonConfig", "ProposalFilledFormConfirmAgent", new { area = "ProposalFilledForm" });
            return View();
        }
        ...
        public IActionResult GetJsonConfig()
        {
            ...
            return Content(System.IO.File.ReadAllText(GlobalConfig.GetJsonConfigFile("ProposalFilledForm", "ProposalFilledFormConfirmAgent")));
        }

        [AreaConfig(Title = "ویرایش فرم پیشنهاد تایید شده نماینده", Icon = "fa-pen")]
        [HttpGet]
        public IActionResult Edit(int fid)
        {
            ViewBag.Title = "ویرایش فرم پیشنهاد تایید شده نماینده";
        ...
        [AreaConfig(Title = "تنظیمات صفحه ویرایش فرم پیشنهاد تایید شده نماینده", Icon = "fa-cog")]
        [HttpPost]
        ...
        [AreaConfig(Title = "ذخیره جزییات فرم پیشنهاد تایید شده نماینده", Icon = "fa-pencil")]
        [HttpPost]
        ...
        [AreaConfig(Title = "ذخیره ارجاع برای فرم پیشنهاد تایید شده نماینده", Icon = "fa-pencil")]
        [HttpPost]
        ...
        [AreaConfig(Title = "تغییر نماینده فرم پیشنهاد تایید شده نماینده", Icon = "fa-pencil")]
        [HttpPost]
        public IActionResult UpdateAgent([FromForm] long? userId, long? id)
        {
            return Json(ProposalFilledFormAdminService.UpdateAgent(id, userId, SiteSettingService.GetSiteSetting()?.Id, HttpContext.GetLoginUser()?.UserId, ProposalFilledFormStatus.Confirm));
        }

        [AreaConfig(Title = "مشاهده جزییات فرم پیشنهاد تایید شده نماینده", Icon = "fa-eye")]
        [HttpPost]
        ...
        [AreaConfig(Title = "حذف فرم پیشنهاد تایید شده نماینده", Icon = "fa-trash-o")]
        [HttpPost]
        ...
        [AreaConfig(Title = "مشاهده وضعیت فرم پیشنهاد تایید شده نماینده", Icon = "fa-eye")]
        [HttpPost]
        ...
        [AreaConfig(Title = "تغییر وضعیت فرم پیشنهاد تایید شده نماینده", Icon = "fa-pencil")]
        [HttpPost]
        ...
        [AreaConfig(Title = "مشاهده لیست کاربران ارجاع داده شده فرم پیشنهاد تایید شده نماینده", Icon = "fa-eye")]
        [HttpPost]
        ...
        [AreaConfig(Title = "مشاهده نماینده فرم پیشنهاد تایید شده نماینده", Icon = "fa-eye")]
        [HttpPost]
        ...
        [AreaConfig(Title = "مشاهده لیست شرکت های فرم پیشنهاد تایید شده نماینده", Icon = "fa-eye")]
        [HttpPost]
        ...
        [AreaConfig(Title = "به روز رسانی شرکت فرم پیشنهاد تایید شده نماینده", Icon = "fa-pencil")]
        [HttpPost]
        ...
        [AreaConfig(Title = "افزودن شرکت فرم پیشنهاد تایید شده نماینده", Icon = "fa-plus")]
        [HttpPost]
        ...
        [AreaConfig(Title = "ویرایش شرکت فرم پیشنهاد تایید شده نماینده", Icon = "fa-pencil")]
        [HttpPost]
        ...
        [AreaConfig(Title = "دانلود پی دی اف فرم پیشنهاد تایید شده نماینده", Icon = "fa-download")]
        [HttpGet]
        ...
        [AreaConfig(Title = "مشاهده اسناد فرم پیشنهاد تایید شده نماینده", Icon = "fa-eye")]
        [HttpPost]
        ...
        [AreaConfig(Title = "حذف اسناد فرم پیشنهاد تایید شده نماینده", Icon = "fa-trash-o")]
        [HttpPost]
        ...
        [AreaConfig(Title = "افزودن اسناد فرم پیشنهاد تایید شده نماینده", Icon = "fa-plus")]
        [HttpPost]
        ...
        [AreaConfig(Title = "جزییات فرم پیشنهاد تایید شده نماینده", Icon = "fa-eye")]
        [HttpGet]
        ...
        [AreaConfig(Title = "مشاهده شرکت تعیین قیمت فرم پیشنهاد تایید شده نماینده", Icon = "fa-eye")]
        [HttpPost]
        ...
        [AreaConfig(Title = "حذف شرکت فرم پیشنهاد تایید شده نماینده", Icon = "fa-trash-o")]
        [HttpPost]
        ...
        [AreaConfig(Title = "انتخاب شرکت فرم پیشنهاد تایید شده نماینده", Icon = "fa-pencil")]
        [HttpPost]
        ...
        [AreaConfig(Title = "مشاهده لیست تعیین قیمت فرم پیشنهاد تایید شده نماینده", Icon = "fa-eye")]
        [HttpPost]
        ...
        [AreaConfig(Title = "مشاهده  پیشنهاد تایید شده نماینده", Icon = "fa-eye")]
        [HttpPost]
        ...
        [AreaConfig(Title = "خروجی اکسل فرم پیشنهاد تایید شده نماینده", Icon = "fa-file-excel")]
        [HttpPost]
        ...
        [AreaConfig(Title = "حذف مدرک مالی فرم پیشنهاد تایید شده نماینده", Icon = "fa-trash-o")]
        [HttpPost]
        ...
        [AreaConfig(Title = "ایجاد مدرک مالی فرم پیشنهاد تایید شده نماینده", Icon = "fa-plus")]
        [HttpPost]
        ...
        [AreaConfig(Title = "به روز رسانی مدرک مالی فرم پیشنهاد تایید شده نماینده", Icon = "fa-pencil")]
        [HttpPost]
        ...
        [AreaConfig(Title = "مشاهده مدرک مالی فرم پیشنهاد تایید شده نماینده", Icon = "fa-eye")]
        [HttpPost]
        ...
        [AreaConfig(Title = "مشاهده لیست مدارک مالی فرم پیشنهاد تایید شده نماینده", Icon = "fa-eye")]
        [HttpPost]
        ...
        [AreaConfig(Title = "خروجی اکسل مدارک مالی فرم پیشنهاد تایید شده نماینده", Icon = "fa-file-excel")]
        [HttpPost]
        ...
        [AreaConfig(Title = "مشاهده لیست تاریخچه وضعیت فرم پیشنهاد تایید شده نماینده", Icon = "fa-eye")]
        [HttpPost]
        ...
        [AreaConfig(Title = "مشاهده مقادیر پیش فرض پیشنهاد تایید شده نماینده", Icon = "fa-eye")]
        [HttpPost]
