...
namespace Oje.Section.ProposalFilledForm.Areas.ProposalFilledForm.Controllers
{
    ...
    public class ProposalFilledFormConfirmAgentController: Controller
    {
        ...
        [AreaConfig(Title = "ایجاد مدرک مالی فرم پیشنهاد تایید شده نماینده", Icon = "fa-trash-o")]
        [HttpPost]
        ...
        [AreaConfig(Title = "ایجاد مدرک مالی فرم پیشنهاد تایید شده نماینده", Icon = "fa-pencil")]
        [HttpPost]
