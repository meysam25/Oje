...
namespace Oje.Section.ProposalFilledForm.Areas.ProposalFilledForm.Controllers
{
    ...
    public class ProposalFilledFormConfirmAgentController: Controller
    {
        ...
        [AreaConfig(Title = "مشاهده شرکت تایین قیمت فرم پیشنهاد تایید شده نماینده", Icon = "fa-eye")]
        [HttpPost]
        ...
        [AreaConfig(Title = "مشاهده لیست تایین قیمت فرم پیشنهاد تایید شده نماینده", Icon = "fa-eye")]
        [HttpPost]
