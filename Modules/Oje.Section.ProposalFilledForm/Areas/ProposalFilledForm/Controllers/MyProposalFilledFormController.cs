...
namespace Oje.Section.ProposalFilledForm.Areas.ProposalFilledForm.Controllers
{
    ...
    [AreaConfig(ModualTitle = "مدیریت بیمه نامه ها", Order = 7,  Icon = "fa-file-powerpoint", Title = "بیمه نامه های من (در انتظار تایید)")]
    ...
    public class MyProposalFilledFormController : Controller
    {
        ...
        [AreaConfig(Title = "بیمه نامه های من (در انتظار تایید)", Icon = "fa-book", IsMainMenuItem = true)]
        [HttpGet]
        public IActionResult Index()
        {
            ViewBag.Title = "بیمه نامه های من (در انتظار تایید)";
            ViewBag.ConfigRoute = Url.Action("GetJsonConfig", "MyProposalFilledForm", new { area = "ProposalFilledForm" });
            return View();
        }

        [AreaConfig(Title = "تنظیمات صفحه بیمه نامه های من (در انتظار تایید)", Icon = "fa-cog")]
        [HttpPost]
        ...
        [AreaConfig(Title = "دانلود پی دی اف بیمه نامه های من (در انتظار تایید)", Icon = "fa-download")]
        [HttpGet]
        ...
        [AreaConfig(Title = "جزییات بیمه نامه های من (در انتظار تایید)", Icon = "fa-eye")]
        [HttpGet]
        ...
        [AreaConfig(Title = "مشاهده بیمه نامه های من (در انتظار تایید)", Icon = "fa-eye")]
        [HttpPost]
        ...
        [AreaConfig(Title = "مشاهده اسناد بیمه نامه های من (در انتظار تایید)", Icon = "fa-eye")]
        [HttpPost]
        ...
        [AreaConfig(Title = "افزودن اسناد بیمه نامه های من (در انتظار تایید)", Icon = "fa-plus")]
        [HttpPost]
        ...
        [AreaConfig(Title = "مشاهده مدارک مالی بیمه نامه های من (در انتظار تایید)", Icon = "fa-eye")]
        [HttpPost]
