...
namespace Oje.Section.ProposalFilledForm.Areas.ProposalFilledForm.Controllers
{
    ...
    public class ProposalFilledFormNewController : Controller
    {
        ...
        [AreaConfig(Title = "مشاهده شرکت تعیین قیمت فرم پیشنهاد جدید", Icon = "fa-eye")]
        [HttpPost]
        ...
        [AreaConfig(Title = "مشاهده لیست تعیین قیمت فرم پیشنهاد جدید", Icon = "fa-eye")]
        [HttpPost]
        ...
        [AreaConfig(Title = "ایجاد مدرک مالی فرم پیشنهاد جدید", Icon = "fa-plus")]
        [HttpPost]
        ...
        [AreaConfig(Title = "به روز رسانی مدرک مالی فرم پیشنهاد جدید", Icon = "fa-pencil")]
        [HttpPost]
        ...
        [AreaConfig(Title = "مشاهده مدرک مالی فرم پیشنهاد جدید", Icon = "fa-eye")]
        [HttpPost]
