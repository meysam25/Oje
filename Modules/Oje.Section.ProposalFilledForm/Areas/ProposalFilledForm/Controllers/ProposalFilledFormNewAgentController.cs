...
namespace Oje.Section.ProposalFilledForm.Areas.ProposalFilledForm.Controllers
{
    ...
    [AreaConfig(ModualTitle = "مدیریت بیمه نامه ها", Order = 12,  Icon = "fa-file-powerpoint", Title = " پیشنهاد جدید")]
    [CustomeAuthorizeFilter]
    public class ProposalFilledFormNewAgentController : Controller
    {
        ...
        public ProposalFilledFormNewAgentController(
        ...
        public IActionResult Index()
        {
            ...
            ViewBag.ConfigRoute = Url.Action("GetJsonConfig", "ProposalFilledFormNewAgent", new { area = "ProposalFilledForm" });
            return View();
        }
        ...
        public IActionResult GetJsonConfig()
        {
            ...
            return Content(System.IO.File.ReadAllText(GlobalConfig.GetJsonConfigFile("ProposalFilledForm", "ProposalFilledFormNewAgent")));
        }

        [AreaConfig(Title = "ویرایش فرم پیشنهاد جدید نماینده", Icon = "fa-pen")]
        [HttpGet]
        public IActionResult Edit(int fid)
        {
            ViewBag.Title = "ویرایش فرم پیشنهاد جدید نماینده";
            ViewBag.exteraParameters = new { fid = fid };
            ViewBag.ConfigRoute = Url.Action("GetEditJsonConfig", "ProposalFilledFormNewAgent", new { area = "ProposalFilledForm" });
            return View("Index");
        }

        [AreaConfig(Title = "تنظیمات صفحه ویرایش فرم پیشنهاد جدید نماینده", Icon = "fa-cog")]
        [HttpPost]
        public IActionResult GetEditJsonConfig(int fid)
        {
            ...
            return Content(ProposalFilledFormAdminService.GetJsonConfir(
                    ...
                    Url.Action("GetById", "ProposalFilledFormNewAgent", new { area = "ProposalFilledForm", id = fid }),
                    Url.Action("Update", "ProposalFilledFormNewAgent", new { area = "ProposalFilledForm", id = fid })
                    )
                );
        }

        [AreaConfig(Title = "ذخیره جزییات فرم پیشنهاد جدید نماینده", Icon = "fa-pencil")]
        [HttpPost]
        ...
        [AreaConfig(Title = "ذخیره ارجاع برای فرم پیشنهاد جدید نماینده", Icon = "fa-pencil")]
        [HttpPost]
        ...
        [AreaConfig(Title = "تغییر نماینده فرم پیشنهاد جدید نماینده", Icon = "fa-pencil")]
        [HttpPost]
        public IActionResult UpdateAgent([FromForm] long? userId, long? id, [FromForm] int? cSOWSiteSettingId)
        {
            return Json(ProposalFilledFormAdminService.UpdateAgent(id, userId, HttpContext?.GetLoginUser()?.canSeeOtherWebsites == true && cSOWSiteSettingId.ToIntReturnZiro() > 0 ? cSOWSiteSettingId : SiteSettingService.GetSiteSetting()?.Id, HttpContext.GetLoginUser()?.UserId, ProposalFilledFormStatus.New));
        }

        [AreaConfig(Title = "مشاهده جزییات فرم پیشنهاد جدید نماینده", Icon = "fa-eye")]
        [HttpPost]
        ...
        [AreaConfig(Title = "حذف فرم پیشنهاد جدید نماینده", Icon = "fa-trash-o")]
        [HttpPost]
        ...
        [AreaConfig(Title = "مشاهده وضعیت فرم پیشنهاد جدید نماینده", Icon = "fa-eye")]
        [HttpPost]
        ...
        [AreaConfig(Title = "تغییر وضعیت فرم پیشنهاد جدید نماینده", Icon = "fa-pencil")]
        [HttpPost]
        ...
        [AreaConfig(Title = "مشاهده لیست کاربران ارجاع داده شده فرم پیشنهاد جدید نماینده", Icon = "fa-eye")]
        [HttpPost]
        ...
        [AreaConfig(Title = "مشاهده نماینده فرم پیشنهاد جدید نماینده", Icon = "fa-eye")]
        [HttpPost]
        ...
        [AreaConfig(Title = "مشاهده لیست شرکت های فرم پیشنهاد جدید نماینده", Icon = "fa-eye")]
        [HttpPost]
        ...
        [AreaConfig(Title = "به روز رسانی شرکت فرم پیشنهاد جدید نماینده", Icon = "fa-pencil")]
        [HttpPost]
        ...
        [AreaConfig(Title = "افزودن شرکت فرم پیشنهاد جدید نماینده", Icon = "fa-plus")]
        [HttpPost]
        ...
        [AreaConfig(Title = "ویرایش شرکت فرم پیشنهاد جدید نماینده", Icon = "fa-pencil")]
        [HttpPost]
        ...
        [AreaConfig(Title = "دانلود پی دی اف فرم پیشنهاد جدید نماینده", Icon = "fa-download")]
        [HttpGet]
        public IActionResult DownloadPdf([FromQuery] GlobalLongId input)
        {
            return File(
                    HtmlToPdfBlink.Convert((Request.IsHttps ? "https" : "http") + "://" + Request.Host + Url.Action("PdfDetailesForAdmin", "ProposalFilledFormNewAgent", new { area = "ProposalFilledForm", id = input.id, isPrint = true }), Request.Cookies),
                    System.Net.Mime.MediaTypeNames.Application.Pdf, DateTime.Now.ToFaDate("_") + "_" + DateTime.Now.ToString("HH_mm_ss") + ".pdf"
                );
        }

        [AreaConfig(Title = "مشاهده اسناد فرم پیشنهاد جدید نماینده", Icon = "fa-eye")]
        [HttpPost]
        ...
        [AreaConfig(Title = "حذف اسناد فرم پیشنهاد جدید نماینده", Icon = "fa-trash-o")]
        [HttpPost]
        ...
        [AreaConfig(Title = "افزودن اسناد فرم پیشنهاد جدید نماینده", Icon = "fa-plus")]
        [HttpPost]
        ...
        [AreaConfig(Title = "جزییات فرم پیشنهاد جدید نماینده", Icon = "fa-eye")]
        [HttpGet]
        public IActionResult PdfDetailesForAdmin([FromQuery] long id, [FromQuery] bool isPrint = false)
        {
            ...
            return View(ProposalFilledFormAdminService.PdfDetailes(id, SiteSettingService.GetSiteSetting()?.Id, HttpContext.GetLoginUser(isPrint)?.UserId, ProposalFilledFormStatus.New));
        }

        [AreaConfig(Title = "مشاهده شرکت تعیین قیمت فرم پیشنهاد جدید نماینده", Icon = "fa-eye")]
        [HttpPost]
        ...
        [AreaConfig(Title = "حذف شرکت فرم پیشنهاد جدید نماینده", Icon = "fa-trash-o")]
        [HttpPost]
        ...
        [AreaConfig(Title = "انتخاب شرکت فرم پیشنهاد جدید نماینده", Icon = "fa-pencil")]
        [HttpPost]
        ...
        [AreaConfig(Title = "مشاهده لیست تعیین قیمت فرم پیشنهاد جدید نماینده", Icon = "fa-eye")]
        [HttpPost]
        ...
        [AreaConfig(Title = "مشاهده  پیشنهاد جدید نماینده", Icon = "fa-eye")]
        [HttpPost]
        public ActionResult GetList([FromForm] ProposalFilledFormMainGrid searchInput)
        {
            return Json(ProposalFilledFormAdminService.GetList(searchInput, SiteSettingService.GetSiteSetting()?.Id, HttpContext.GetLoginUser()?.UserId, ProposalFilledFormStatus.New, HttpContext.GetLoginUser()?.roles));
        }

        [AreaConfig(Title = "خروجی اکسل فرم پیشنهاد جدید نماینده", Icon = "fa-file-excel")]
        [HttpPost]
        public ActionResult Export([FromForm] ProposalFilledFormMainGrid searchInput)
        {
            var result = ProposalFilledFormAdminService.GetList(searchInput, SiteSettingService.GetSiteSetting()?.Id, HttpContext.GetLoginUser()?.UserId, ProposalFilledFormStatus.New, HttpContext.GetLoginUser()?.roles);
            if (result == null || result.data == null || result.data.Count == 0)
                throw BException.GenerateNewException(BMessages.Not_Found);
            var byteResult = ExportToExcel.Export(result.data);
            if (byteResult == null || byteResult.Length == 0)
        ...
        [AreaConfig(Title = "حذف مدرک مالی فرم پیشنهاد جدید نماینده", Icon = "fa-trash-o")]
        [HttpPost]
        ...
        [AreaConfig(Title = "ایجاد مدرک مالی فرم پیشنهاد جدید نماینده", Icon = "fa-plus")]
        [HttpPost]
        ...
        [AreaConfig(Title = "به روز رسانی مدرک مالی فرم پیشنهاد جدید نماینده", Icon = "fa-pencil")]
        [HttpPost]
        ...
        [AreaConfig(Title = "مشاهده مدرک مالی فرم پیشنهاد جدید نماینده", Icon = "fa-eye")]
        [HttpPost]
        ...
        [AreaConfig(Title = "مشاهده لیست مدارک مالی فرم پیشنهاد جدید نماینده", Icon = "fa-eye")]
        [HttpPost]
        ...
        [AreaConfig(Title = "خروجی اکسل مدارک مالی فرم پیشنهاد جدید نماینده", Icon = "fa-file-excel")]
        [HttpPost]
        ...
        [AreaConfig(Title = "مشاهده لیست تاریخچه وضعیت فرم پیشنهاد جدید نماینده", Icon = "fa-eye")]
        [HttpPost]
