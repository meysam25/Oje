...
namespace Oje.Section.ProposalFilledForm.Areas.ProposalFilledForm.Controllers
{
    ...
    public class ProposalFilledFormNewAgentController : Controller
    {
        ...
        [AreaConfig(Title = "مشاهده شرکت تایین قیمت فرم پیشنهاد جدید نماینده", Icon = "fa-eye")]
        [HttpPost]
        ...
        [AreaConfig(Title = "مشاهده لیست تایین قیمت فرم پیشنهاد جدید نماینده", Icon = "fa-eye")]
        [HttpPost]
