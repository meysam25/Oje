...
namespace Oje.Section.ProposalFilledForm.Areas.ProposalFilledForm.Controllers
{
    ...
    public class ProposalFilledFormNeedSpecialistAgentController: Controller
    {
        ...
        [AreaConfig(Title = "مشاهده شرکت تایین قیمت فرم پیشنهاد نیاز به کارشناسی نماینده", Icon = "fa-eye")]
        [HttpPost]
        ...
        [AreaConfig(Title = "مشاهده لیست تایین قیمت فرم پیشنهاد نیاز به کارشناسی نماینده", Icon = "fa-eye")]
        [HttpPost]
        ...
        [AreaConfig(Title = "ایجاد مدرک مالی فرم پیشنهاد نیاز به کارشناسی نماینده", Icon = "fa-trash-o")]
        [HttpPost]
        ...
        [AreaConfig(Title = "ایجاد مدرک مالی فرم پیشنهاد نیاز به کارشناسی نماینده", Icon = "fa-pencil")]
        [HttpPost]
