...
namespace Oje.Section.ProposalFilledForm.Areas.ProposalFilledForm.Controllers
{
    ...
    public class ProposalFilledFormW8ForConfirmController : Controller
    {
        ...
        public ProposalFilledFormW8ForConfirmController(
        ...
        [AreaConfig(Title = "لیست فرم پیشنهاد در انتظار تایید", Icon = "fa-file-o", IsMainMenuItem = true)]
        [HttpGet]
        ...
        public IActionResult GetJsonConfig()
        {
            ...
            return Content(System.IO.File.ReadAllText(GlobalConfig.GetJsonConfigFile("ProposalFilledForm", "ProposalFilledFormW8ForConfirm")));
        }

        [AreaConfig(Title = "ویرایش فرم پیشنهاد در انتظار تایید", Icon = "fa-pen")]
        [HttpGet]
        public IActionResult Edit(int fid)
        {
            ViewBag.Title = "ویرایش فرم پیشنهاد در انتظار تایید";
            ViewBag.exteraParameters = new { fid = fid };
            ViewBag.ConfigRoute = Url.Action("GetEditJsonConfig", "ProposalFilledFormW8ForConfirm", new { area = "ProposalFilledForm" });
            return View("Index");
        }

        [AreaConfig(Title = "تنظیمات صفحه ویرایش فرم پیشنهاد در انتظار تایید", Icon = "fa-cog")]
        [HttpPost]
        public IActionResult GetEditJsonConfig(int fid)
        {
            Response.ContentType = "application/json; charset=utf-8";
            return Content(ProposalFilledFormAdminManager.GetJsonConfir(
                    fid, SiteSettingManager.GetSiteSetting()?.Id, HttpContext.GetLoginUserId()?.UserId, ProposalFilledFormStatus.W8ForConfirm,
        ...
        [AreaConfig(Title = "ذخیره جزییات فرم پیشنهاد در انتظار تایید", Icon = "fa-pencil")]
        [HttpPost]
        public IActionResult Update([FromQuery] GlobalLongId input)
        {
            return Json(ProposalFilledFormAdminManager.Update(input?.id, SiteSettingManager.GetSiteSetting()?.Id, HttpContext.GetLoginUserId()?.UserId, ProposalFilledFormStatus.W8ForConfirm, Request.Form));
        }


        [AreaConfig(Title = "ذخیره ارجاع برای فرم پیشنهاد در انتظار تایید", Icon = "fa-pencil")]
        [HttpPost]
        public IActionResult CreateUserRefer([FromForm] CreateUpdateProposalFilledFormUserReffer input)
        {
            return Json(ProposalFilledFormAdminManager.CreateUserRefer(input, SiteSettingManager.GetSiteSetting()?.Id, HttpContext.GetLoginUserId()?.UserId, ProposalFilledFormStatus.W8ForConfirm));
        }
        ...
        {
            return Json(ProposalFilledFormAdminManager.UpdateAgent(id, userId, SiteSettingManager.GetSiteSetting()?.Id, HttpContext.GetLoginUserId()?.UserId, ProposalFilledFormStatus.W8ForConfirm));
        }
        ...
        {
            return Json(ProposalFilledFormAdminManager.GetById(input?.id, SiteSettingManager.GetSiteSetting()?.Id, HttpContext.GetLoginUserId()?.UserId, ProposalFilledFormStatus.W8ForConfirm));
        }
        ...
        {
            return Json(ProposalFilledFormAdminManager.Delete(input?.id, SiteSettingManager.GetSiteSetting()?.Id, HttpContext.GetLoginUserId()?.UserId, ProposalFilledFormStatus.W8ForConfirm));
        }
        ...
        {
            return Json(ProposalFilledFormAdminManager.GetStatus(input?.id, SiteSettingManager.GetSiteSetting()?.Id, HttpContext.GetLoginUserId()?.UserId, ProposalFilledFormStatus.W8ForConfirm));
        }
        ...
        {
            return Json(ProposalFilledFormAdminManager.UpdateStatus(input, SiteSettingManager.GetSiteSetting()?.Id, HttpContext.GetLoginUserId()?.UserId, ProposalFilledFormStatus.W8ForConfirm));
        }
        ...
        {
            return Json(ProposalFilledFormAdminManager.GetRefferUsers(input?.id, SiteSettingManager.GetSiteSetting()?.Id, HttpContext.GetLoginUserId()?.UserId, ProposalFilledFormStatus.W8ForConfirm));
        }
        ...
        {
            return Json(ProposalFilledFormAdminManager.GetAgent(input?.id, SiteSettingManager.GetSiteSetting()?.Id, HttpContext.GetLoginUserId()?.UserId, ProposalFilledFormStatus.W8ForConfirm));
        }
        ...
        {
            return Json(ProposalFilledFormAdminManager.GetCompanies(input?.id, SiteSettingManager.GetSiteSetting()?.Id, HttpContext.GetLoginUserId()?.UserId, ProposalFilledFormStatus.W8ForConfirm));
        }
        ...
        {
            return Json(ProposalFilledFormAdminManager.UpdateCompanies(input, SiteSettingManager.GetSiteSetting()?.Id, HttpContext.GetLoginUserId()?.UserId, ProposalFilledFormStatus.W8ForConfirm));
        }
        ...
        {
            return Json(ProposalFilledFormCompanyManager.Create(input, SiteSettingManager.GetSiteSetting()?.Id, HttpContext.GetLoginUserId()?.UserId, ProposalFilledFormStatus.W8ForConfirm));
        }
        ...
        {
            return Json(ProposalFilledFormCompanyManager.Update(input, SiteSettingManager.GetSiteSetting()?.Id, HttpContext.GetLoginUserId()?.UserId, ProposalFilledFormStatus.W8ForConfirm));
        }
        ...
        {
            return File(
                    HtmlToPdfBlink.Convert((Request.IsHttps ? "https" : "http") + "://" + Request.Host + Url.Action("PdfDetailesForAdmin", "ProposalFilledFormW8ForConfirm", new { area = "ProposalFilledForm", id = input.id, isPrint = true }), Request.Cookies),
                    System.Net.Mime.MediaTypeNames.Application.Pdf, DateTime.Now.ToFaDate("_") + "_" + DateTime.Now.ToString("HH_mm_ss") + ".pdf"
                );
        }

        [AreaConfig(Title = "مشاهده اسناد فرم پیشنهاد در انتظار تایید", Icon = "fa-eye")]
        [HttpPost]
        public ActionResult GetPPFImageList([FromForm] GlobalGridParentLong input)
        {
            return Json(ProposalFilledFormAdminManager.GetUploadImages(input, SiteSettingManager.GetSiteSetting()?.Id, HttpContext.GetLoginUserId()?.UserId, ProposalFilledFormStatus.W8ForConfirm));
        }
        ...
        {
            return Json(ProposalFilledFormAdminManager.DeleteUploadImage(input?.id, pKey, SiteSettingManager.GetSiteSetting()?.Id, HttpContext.GetLoginUserId()?.UserId, ProposalFilledFormStatus.W8ForConfirm));
        }
        ...
        {
            return Json(ProposalFilledFormAdminManager.UploadImage(pKey, mainFile, SiteSettingManager.GetSiteSetting()?.Id, HttpContext.GetLoginUserId()?.UserId, ProposalFilledFormStatus.W8ForConfirm));
        }
        ...
        public IActionResult PdfDetailesForAdmin([FromQuery] long id, [FromQuery] bool isPrint = false)
        {
            ...
            return View(ProposalFilledFormAdminManager.PdfDetailes(id, SiteSettingManager.GetSiteSetting()?.Id, HttpContext.GetLoginUserId()?.UserId, ProposalFilledFormStatus.W8ForConfirm));
        }
        ...
        {
            return Json(ProposalFilledFormCompanyManager.GetBy(input?.id, SiteSettingManager.GetSiteSetting()?.Id, HttpContext.GetLoginUserId()?.UserId, ProposalFilledFormStatus.W8ForConfirm));
        }
        ...
        {
            return Json(ProposalFilledFormCompanyManager.Delete(input?.id, SiteSettingManager.GetSiteSetting()?.Id, HttpContext.GetLoginUserId()?.UserId, ProposalFilledFormStatus.W8ForConfirm));
        }
        ...
        {
            return Json(ProposalFilledFormCompanyManager.Select(input?.id, SiteSettingManager.GetSiteSetting()?.Id, HttpContext.GetLoginUserId()?.UserId, ProposalFilledFormStatus.W8ForConfirm));
        }


        [AreaConfig(Title = "مشاهده لیست تایین قیمت فرم پیشنهاد در انتظار تایید", Icon = "fa-eye")]
        [HttpPost]
        public ActionResult GetPricingCompanyList([FromForm] ProposalFilledFormCompanyPriceMainGrid searchInput)
        {
            return Json(ProposalFilledFormCompanyManager.GetList(searchInput, SiteSettingManager.GetSiteSetting()?.Id, HttpContext.GetLoginUserId()?.UserId, ProposalFilledFormStatus.W8ForConfirm));
        }
        ...
        {
            var result = ProposalFilledFormCompanyManager.GetList(searchInput, SiteSettingManager.GetSiteSetting()?.Id, HttpContext.GetLoginUserId()?.UserId, ProposalFilledFormStatus.W8ForConfirm);
        ...
        {
            return Json(ProposalFilledFormAdminManager.GetList(searchInput, SiteSettingManager.GetSiteSetting()?.Id, HttpContext.GetLoginUserId()?.UserId, ProposalFilledFormStatus.W8ForConfirm));
        }
        ...
        {
            var result = ProposalFilledFormAdminManager.GetList(searchInput, SiteSettingManager.GetSiteSetting()?.Id, HttpContext.GetLoginUserId()?.UserId, ProposalFilledFormStatus.W8ForConfirm);
            if (result == null || result.data == null || result.data.Count == 0)
                return NotFound();
            var byteResult = ExportToExcel.Export(result.data);
            if (byteResult == null || byteResult.Length == 0)
        ...
        {
            return Json(ProposalFilledFormDocumentManager.Delete(input?.id, pKey, SiteSettingManager.GetSiteSetting()?.Id, HttpContext.GetLoginUserId()?.UserId, ProposalFilledFormStatus.W8ForConfirm));
        }
        ...
        {
            return Json(ProposalFilledFormDocumentManager.Create(input, SiteSettingManager.GetSiteSetting()?.Id, HttpContext.GetLoginUserId()?.UserId, ProposalFilledFormStatus.W8ForConfirm));
        }
        ...
        {
            return Json(ProposalFilledFormDocumentManager.Update(input, SiteSettingManager.GetSiteSetting()?.Id, HttpContext.GetLoginUserId()?.UserId, ProposalFilledFormStatus.W8ForConfirm));
        }
        ...
        {
            return Json(ProposalFilledFormDocumentManager.GetBy(input?.id, pKey, SiteSettingManager.GetSiteSetting()?.Id, HttpContext.GetLoginUserId()?.UserId, ProposalFilledFormStatus.W8ForConfirm));
        }
        ...
        {
            return Json(ProposalFilledFormDocumentManager.GetList(searchInput, SiteSettingManager.GetSiteSetting()?.Id, HttpContext.GetLoginUserId()?.UserId, ProposalFilledFormStatus.W8ForConfirm));
        }
        ...
        {
            var result = ProposalFilledFormDocumentManager.GetList(searchInput, SiteSettingManager.GetSiteSetting()?.Id, HttpContext.GetLoginUserId()?.UserId, ProposalFilledFormStatus.W8ForConfirm);
            if (result == null || result.data == null || result.data.Count == 0)
                return NotFound();
            var byteResult = ExportToExcel.Export(result.data);
            if (byteResult == null || byteResult.Length == 0)
        ...
        [AreaConfig(Title = "مشاهده لیست تاریخچه وضعیت فرم پیشنهاد در انتظار تایید", Icon = "fa-eye")]
        [HttpPost]
