...
namespace Oje.Section.ProposalFilledForm.Areas.ProposalFilledForm.Controllers
{
    ...
    [AreaConfig(ModualTitle = "مدیریت بیمه نامه ها", Order = 12,  Icon = "fa-file-powerpoint", Title = "پیشنهاد رد شده")]
    [CustomeAuthorizeFilter]
    public class ProposalFilledFormNotIssueAgentController : Controller
    {
        ...
        public ProposalFilledFormNotIssueAgentController(
        ...
        [AreaConfig(Title = "پیشنهاد رد شده", Icon = "fa-print-slash", IsMainMenuItem = true)]
        [HttpGet]
        public IActionResult Index()
        {
            ViewBag.Title = "پیشنهاد رد شده ";
            ViewBag.ConfigRoute = Url.Action("GetJsonConfig", "ProposalFilledFormNotIssueAgent", new { area = "ProposalFilledForm" });
            return View();
        }

        [AreaConfig(Title = "تنظیمات صفحه پیشنهاد رد شده ", Icon = "fa-cog")]
        [HttpPost]
        public IActionResult GetJsonConfig()
        {
            Response.ContentType = "application/json; charset=utf-8";
            return Content(System.IO.File.ReadAllText(GlobalConfig.GetJsonConfigFile("ProposalFilledForm", "ProposalFilledFormNotIssueAgent")));
        }

        [AreaConfig(Title = "ویرایش فرم پیشنهاد رد شده نماینده", Icon = "fa-pen")]
        [HttpGet]
        public IActionResult Edit(int fid)
        {
            ViewBag.Title = "ویرایش فرم پیشنهاد رد شده نماینده";
            ViewBag.exteraParameters = new { fid = fid };
            ViewBag.ConfigRoute = Url.Action("GetEditJsonConfig", "ProposalFilledFormNotIssueAgent", new { area = "ProposalFilledForm" });
            return View("Index");
        }

        [AreaConfig(Title = "تنظیمات صفحه ویرایش فرم پیشنهاد رد شده نماینده", Icon = "fa-cog")]
        [HttpPost]
        public IActionResult GetEditJsonConfig(int fid)
        {
            ...
            return Content(ProposalFilledFormAdminService.GetJsonConfir(
                    ...
                    Url.Action("GetById", "ProposalFilledFormNotIssueAgent", new { area = "ProposalFilledForm", id = fid }),
                    Url.Action("Update", "ProposalFilledFormNotIssueAgent", new { area = "ProposalFilledForm", id = fid })
                    )
                );
        }

        [AreaConfig(Title = "ذخیره جزییات فرم پیشنهاد رد شده نماینده", Icon = "fa-pencil")]
        [HttpPost]
        ...
        [AreaConfig(Title = "ذخیره ارجاع برای فرم پیشنهاد رد شده نماینده", Icon = "fa-pencil")]
        [HttpPost]
        ...
        [AreaConfig(Title = "تغییر نماینده فرم پیشنهاد رد شده نماینده", Icon = "fa-pencil")]
        [HttpPost]
        public IActionResult UpdateAgent([FromForm] long? userId, long? id, [FromForm] int? cSOWSiteSettingId)
        {
            return Json(ProposalFilledFormAdminService.UpdateAgent(id, userId, HttpContext?.GetLoginUser()?.canSeeOtherWebsites == true && cSOWSiteSettingId.ToIntReturnZiro() > 0 ? cSOWSiteSettingId : SiteSettingService.GetSiteSetting()?.Id, HttpContext.GetLoginUser()?.UserId, ProposalFilledFormStatus.NotIssue));
        }

        [AreaConfig(Title = "مشاهده جزییات فرم پیشنهاد رد شده نماینده", Icon = "fa-eye")]
        [HttpPost]
        ...
        [AreaConfig(Title = "حذف فرم پیشنهاد رد شده نماینده", Icon = "fa-trash-o")]
        [HttpPost]
        ...
        [AreaConfig(Title = "مشاهده وضعیت فرم پیشنهاد رد شده نماینده", Icon = "fa-eye")]
        [HttpPost]
        ...
        [AreaConfig(Title = "تغییر وضعیت فرم پیشنهاد رد شده نماینده", Icon = "fa-pencil")]
        [HttpPost]
        ...
        [AreaConfig(Title = "مشاهده لیست کاربران ارجاع داده شده فرم پیشنهاد رد شده نماینده", Icon = "fa-eye")]
        [HttpPost]
        ...
        [AreaConfig(Title = "مشاهده نماینده فرم پیشنهاد رد شده نماینده", Icon = "fa-eye")]
        [HttpPost]
        ...
        [AreaConfig(Title = "مشاهده لیست شرکت های فرم پیشنهاد رد شده نماینده", Icon = "fa-eye")]
        [HttpPost]
        ...
        [AreaConfig(Title = "به روز رسانی شرکت فرم پیشنهاد رد شده نماینده", Icon = "fa-pencil")]
        [HttpPost]
        ...
        [AreaConfig(Title = "افزودن شرکت فرم پیشنهاد رد شده نماینده", Icon = "fa-plus")]
        [HttpPost]
        ...
        [AreaConfig(Title = "ویرایش شرکت فرم پیشنهاد رد شده نماینده", Icon = "fa-pencil")]
        [HttpPost]
        ...
        [AreaConfig(Title = "دانلود پی دی اف فرم پیشنهاد رد شده نماینده", Icon = "fa-download")]
        [HttpGet]
        public IActionResult DownloadPdf([FromQuery] GlobalLongId input)
        {
            return File(
                    HtmlToPdfBlink.Convert((Request.IsHttps ? "https" : "http") + "://" + Request.Host + Url.Action("PdfDetailesForAdmin", "ProposalFilledFormNotIssueAgent", new { area = "ProposalFilledForm", id = input.id, isPrint = true }), Request.Cookies),
                    System.Net.Mime.MediaTypeNames.Application.Pdf, DateTime.Now.ToFaDate("_") + "_" + DateTime.Now.ToString("HH_mm_ss") + ".pdf"
                );
        }

        [AreaConfig(Title = "مشاهده اسناد فرم پیشنهاد رد شده نماینده", Icon = "fa-eye")]
        [HttpPost]
        ...
        [AreaConfig(Title = "حذف اسناد فرم پیشنهاد رد شده نماینده", Icon = "fa-trash-o")]
        [HttpPost]
        ...
        [AreaConfig(Title = "افزودن اسناد فرم پیشنهاد رد شده نماینده", Icon = "fa-plus")]
        [HttpPost]
        ...
        [AreaConfig(Title = "جزییات فرم پیشنهاد رد شده نماینده", Icon = "fa-eye")]
        [HttpGet]
        public IActionResult PdfDetailesForAdmin([FromQuery] long id, [FromQuery] bool isPrint = false)
        {
            ...
            return View(ProposalFilledFormAdminService.PdfDetailes(id, SiteSettingService.GetSiteSetting()?.Id, HttpContext.GetLoginUser(isPrint)?.UserId, ProposalFilledFormStatus.NotIssue));
        }

        [AreaConfig(Title = "مشاهده شرکت تعیین قیمت فرم پیشنهاد رد شده نماینده", Icon = "fa-eye")]
        [HttpPost]
        ...
        [AreaConfig(Title = "حذف شرکت فرم پیشنهاد رد شده نماینده", Icon = "fa-trash-o")]
        [HttpPost]
        ...
        [AreaConfig(Title = "انتخاب شرکت فرم پیشنهاد رد شده نماینده", Icon = "fa-pencil")]
        [HttpPost]
        ...
        [AreaConfig(Title = "مشاهده لیست تعیین قیمت فرم پیشنهاد رد شده نماینده", Icon = "fa-eye")]
        [HttpPost]
        ...
        [AreaConfig(Title = "مشاهده پیشنهاد رد شده نماینده", Icon = "fa-eye")]
        [HttpPost]
        ...
        [AreaConfig(Title = "خروجی اکسل فرم پیشنهاد رد شده نماینده", Icon = "fa-file-excel")]
        [HttpPost]
        ...
        [AreaConfig(Title = "حذف مدرک مالی فرم پیشنهاد رد شده نماینده", Icon = "fa-trash-o")]
        [HttpPost]
        ...
        [AreaConfig(Title = "ایجاد مدرک مالی فرم پیشنهاد رد شده نماینده", Icon = "fa-plus")]
        [HttpPost]
        ...
        [AreaConfig(Title = "به روز رسانی مدرک مالی فرم پیشنهاد رد شده نماینده", Icon = "fa-pencil")]
        [HttpPost]
        ...
        [AreaConfig(Title = "مشاهده مدرک مالی فرم پیشنهاد رد شده نماینده", Icon = "fa-eye")]
        [HttpPost]
        ...
        [AreaConfig(Title = "مشاهده لیست مدارک مالی فرم پیشنهاد رد شده نماینده", Icon = "fa-eye")]
        [HttpPost]
        ...
        [AreaConfig(Title = "خروجی اکسل مدارک مالی فرم پیشنهاد رد شده نماینده", Icon = "fa-file-excel")]
        [HttpPost]
        ...
        [AreaConfig(Title = "مشاهده لیست تاریخچه وضعیت فرم پیشنهاد رد شده نماینده", Icon = "fa-eye")]
        [HttpPost]
