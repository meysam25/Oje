...
namespace Oje.Section.ProposalFilledFormChartReports.Areas.ProposalFilledFormChartReports.Controllers
{
    ...
    [AreaConfig(ModualTitle = "گزارش چارت فرم پیشنهاد", Icon = "fa-chart-pie", Title = "وضعیت فرم پیشنهاد")]
    ...
    public class ProposalFilledFormStatusChartController: Controller
    {
        ...
        {
            return Json(ProposalFilledFormService.GetStatusChartReport(SiteSettingService.GetSiteSetting()?.Id, HttpContext.GetLoginUserId()?.UserId));
        }
    }
}
