...
namespace Oje.Section.Ticket.Areas.Ticket.Controllers
{
    ...
    [AreaConfig(ModualTitle = "پشتیبانی تیکت و پیام ها", Order = 9, Icon = "fa-ticket", Title = "پیام های ضروری")]
    ...
    public class UserNotificationController : Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            ViewBag.ConfigRoute = Url.Action("GetJsonConfig", "UserNotification", new { area = "Ticket" });
            return View();
        }
        ...
        public IActionResult GetJsonConfig()
        {
            ...
            return Content(System.IO.File.ReadAllText(GlobalConfig.GetJsonConfigFile("Ticket", "UserNotification")));
        }
