...
namespace Oje.Section.InsuranceContractBaseData.Areas.InsuranceContractBaseDataSuperAdmin.Controllers
{
    ...
    public class InsuranceContractController : Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            ViewBag.ConfigRoute = Url.Action("GetJsonConfig", "InsuranceContract", new { area = "InsuranceContractBaseDataSuperAdmin" });
            return View();
        }
        ...
        public IActionResult GetJsonConfig()
        {
            ...
            return Content(System.IO.File.ReadAllText(GlobalConfig.GetJsonConfigFile("InsuranceContractBaseDataSuperAdmin", "InsuranceContract")));
        }
