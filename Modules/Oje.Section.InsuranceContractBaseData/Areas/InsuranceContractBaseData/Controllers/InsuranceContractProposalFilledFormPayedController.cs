...
namespace Oje.Section.InsuranceContractBaseData.Areas.InsuranceContractBaseData.Controllers
{
    ...
    public class InsuranceContractProposalFilledFormPayedController : Controller
    {
        ...
        readonly InsuranceContractProposalFilledFormType status = InsuranceContractProposalFilledFormType.Payed;
        readonly IInsuranceContractProposalFilledFormUserService InsuranceContractProposalFilledFormUserService = null;

        public InsuranceContractProposalFilledFormPayedController
            (
        ...
        [AreaConfig(Title = "مشاهده لیست جزئیات خسارت های پرداخت شده", Icon = "fa-list-alt")]
        [HttpPost]
