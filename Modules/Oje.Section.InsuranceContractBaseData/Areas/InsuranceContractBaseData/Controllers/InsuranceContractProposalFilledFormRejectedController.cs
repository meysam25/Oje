...
namespace Oje.Section.InsuranceContractBaseData.Areas.InsuranceContractBaseData.Controllers
{
    ...
    [AreaConfig(ModualTitle = "سامانه درمان وب", Order = 5, Icon = "fa-file-invoice", Title = "خسارت های غیر قابل پرداخت")]
    ...
    public class InsuranceContractProposalFilledFormRejectedController : Controller
    {
        ...
        [AreaConfig(Title = "خسارت های غیر قابل پرداخت", Icon = "fa-folder-times", IsMainMenuItem = true)]
        [HttpGet]
        ...
        [AreaConfig(Title = "حذف خسارت های غیر قابل پرداخت", Icon = "fa-trash-o")]
        [HttpPost]
        ...
        [AreaConfig(Title = "مشاهده لیست تاریخچه خسارت غیر قابل پرداخت", Icon = "fa-list-alt")]
        [HttpPost]
        ...
        [AreaConfig(Title = "مشاهده مدارک لیست خسارت های غیر قابل پرداخت", Icon = "fa-list-alt")]
        [HttpPost]
        ...
        [AreaConfig(Title = "مشاهده لیست جزئیات خسارت های غیر قابل پرداخت", Icon = "fa-list-alt")]
        [HttpPost]
