...
namespace Oje.Section.InsuranceContractBaseData.Areas.InsuranceContractBaseData.Controllers
{
    ...
    public class InsuranceContractInsuranceContractTypeMaxPriceController: Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            ViewBag.ConfigRoute = Url.Action("GetJsonConfig", "InsuranceContractInsuranceContractTypeMaxPrice", new { area = "InsuranceContractBaseData" });
            return View();
        }
        ...
        public IActionResult GetJsonConfig()
        {
            ...
            return Content(System.IO.File.ReadAllText(GlobalConfig.GetJsonConfigFile("InsuranceContractBaseData", "InsuranceContractInsuranceContractTypeMaxPrice")));
        }
        ...
        {
            return Json(InsuranceContractTypeService.GetLightListBySiteSettingId(SiteSettingService.GetSiteSetting()?.Id));
        }
        ...
        {
            return Json(InsuranceContractService.GetLightList(SiteSettingService.GetSiteSetting()?.Id));
