...
namespace Oje.Section.InsuranceContractBaseData.Areas.InsuranceContractBaseData.Controllers
{
    ...
    [AreaConfig(ModualTitle = "سامانه درمان وب", Order = 5, Icon = "fa-file-invoice", Title = "خسارت های تایید شده در انتظار دریافت اصل مدارک")]
    ...
    public class InsuranceContractProposalFilledFormW8ForReciveingRealDocumentsController : Controller
    {
        ...
        readonly InsuranceContractProposalFilledFormType status = InsuranceContractProposalFilledFormType.W8ForReciveingRealDocuments;
        readonly IInsuranceContractProposalFilledFormUserService InsuranceContractProposalFilledFormUserService = null;

        public InsuranceContractProposalFilledFormW8ForReciveingRealDocumentsController
            (
        ...
        [AreaConfig(Title = "مشاهده لیست جزئیات خسارت های در انتظار دریافت اصل مدارک", Icon = "fa-list-alt")]
        [HttpPost]
