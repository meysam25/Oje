...
namespace Oje.Section.InsuranceContractBaseData.Areas.InsuranceContractBaseData.Controllers
{
    ...
    [AreaConfig(ModualTitle = "سامانه درمان وب", Order = 5, Icon = "fa-file-invoice", Title = "خسارت های ثبت شده جدید")]
    ...
    public class InsuranceContractProposalFilledFormController : Controller
    {
        ...
        [AreaConfig(Title = "مشاهده لیست جزئیات خسارت های ثبت شده جدید", Icon = "fa-list-alt")]
        [HttpPost]
