...
namespace Oje.Section.InsuranceContractBaseData.Areas.InsuranceContractBaseData.Controllers
{
    ...
    [AreaConfig(ModualTitle = "سامانه درمان وب", Order = 5, Icon = "fa-file-invoice", Title = "خسارت های جدید")]
    ...
    public class MyFilledContractController : Controller
    {
        ...
        [AreaConfig(Title = "خسارت های جدید", Icon = "fa-layer-plus", IsMainMenuItem = true)]
        [HttpGet]
