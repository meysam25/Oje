...
namespace Oje.Section.InsuranceContractBaseData.Areas.InsuranceContractBaseData.Controllers
{
    ...
    [AreaConfig(ModualTitle = "مدیریت قرارداد ها و مجوز ها", Icon = "fa-file-invoice", Title = "خسارت های ثبت شده در حال برسی")]
    ...
    public class InsuranceContractProposalFilledFormPendingController : Controller
    {
        ...
        [AreaConfig(Title = "خسارت های ثبت شده در حال برسی", Icon = "fa-hospital-symbol", IsMainMenuItem = true)]
        [HttpGet]
