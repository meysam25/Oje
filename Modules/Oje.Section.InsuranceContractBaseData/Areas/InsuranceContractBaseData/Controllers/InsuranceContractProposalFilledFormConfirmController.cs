...
namespace Oje.Section.InsuranceContractBaseData.Areas.InsuranceContractBaseData.Controllers
{
    ...
    [AreaConfig(ModualTitle = "سامانه درمان وب", Order = 5, Icon = "fa-file-invoice", Title = "خسارت های تایید شده")]
    ...
    public class InsuranceContractProposalFilledFormConfirmController : Controller
    {
        ...
        [AreaConfig(Title = "حذف خسارت های تایید شده", Icon = "fa-trash-o")]
        [HttpPost]
        ...
        [AreaConfig(Title = "مشاهده مدارک لیست خسارت های تایید شده", Icon = "fa-list-alt")]
        [HttpPost]
        ...
        [AreaConfig(Title = "مشاهده لیست جزئیات خسارت های تایید شده", Icon = "fa-list-alt")]
        [HttpPost]
