...
namespace Oje.Section.RegisterForm.Areas.RegisterFormAdmin.Controllers
{
    ...
    [AreaConfig(ModualTitle = "ثبت نام کاربر", Icon = "fa-users", Title = "مبلغ فرم ثبت نام")]
    ...
    public class UserRegisterFormPriceController : Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            ViewBag.ConfigRoute = Url.Action("GetJsonConfig", "UserRegisterFormPrice", new { area = "RegisterFormAdmin" });
            return View();
        }
        ...
        public IActionResult GetJsonConfig()
        {
            ...
            return Content(System.IO.File.ReadAllText(GlobalConfig.GetJsonConfigFile("RegisterFormAdmin", "UserRegisterFormPrice")));
        }
