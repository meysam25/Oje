...
namespace Oje.Section.RegisterForm.Areas.RegisterFormSupperAdmin.Controllers
{
    ...
    [AreaConfig(ModualTitle = "پایه ثبت نام کاربر", Icon = "fa-users", Title = "گروه بندی فرم")]
    ...
    public class UserRegisterFormCategoryController : Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            ViewBag.ConfigRoute = Url.Action("GetJsonConfig", "UserRegisterFormCategory", new { area = "RegisterFormSupperAdmin" });
            return View();
        }
        ...
        public IActionResult GetJsonConfig()
        {
            ...
            return Content(System.IO.File.ReadAllText(GlobalConfig.GetJsonConfigFile("RegisterFormSupperAdmin", "UserRegisterFormCategory")));
        }
