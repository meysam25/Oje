...
namespace Oje.Section.RegisterForm.Areas.RegisterFormSupperAdmin.Controllers
{
    ...
    [AreaConfig(ModualTitle = "پایه ثبت نام کاربر", Icon = "fa-users", Title = "نوع مدارک مورد نیاز فرم ثبت نام")]
    ...
    public class UserRegisterFormRequiredDocumentTypeController : Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            ViewBag.ConfigRoute = Url.Action("GetJsonConfig", "UserRegisterFormRequiredDocumentType", new { area = "RegisterFormSupperAdmin" });
            return View();
        }
        ...
        public IActionResult GetJsonConfig()
        {
            ...
            return Content(System.IO.File.ReadAllText(GlobalConfig.GetJsonConfigFile("RegisterFormSupperAdmin", "UserRegisterFormRequiredDocumentType")));
        }
        ...
        [HttpPost]
        public IActionResult GetFormList([FromQuery] int? cSOWSiteSettingId)
        {
