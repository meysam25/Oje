...
namespace Oje.Section.RegisterForm.Areas.RegisterFormSupperAdmin.Controllers
{
    ...
    [AreaConfig(ModualTitle = "پایه ثبت نام کاربر", Icon = "fa-users", Title = "شرکت های ثبت نام")]
    ...
    public class UserRegisterFormCompanyController : Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            ViewBag.ConfigRoute = Url.Action("GetJsonConfig", "UserRegisterFormCompany", new { area = "RegisterFormSupperAdmin" });
            return View();
        }
        ...
        public IActionResult GetJsonConfig()
        {
            ...
            return Content(System.IO.File.ReadAllText(GlobalConfig.GetJsonConfigFile("RegisterFormSupperAdmin", "UserRegisterFormCompany")));
        }
