...
namespace Oje.Section.RegisterForm.Areas.RegisterFormSupperAdmin.Controllers
{
    ...
    [AreaConfig(ModualTitle = "پایه ثبت نام کاربر", Icon = "fa-users", Title = "مدارک مورد نیاز ثبت نام")]
    ...
    public class UserRegisterFormRequiredDocumentController : Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            ViewBag.ConfigRoute = Url.Action("GetJsonConfig", "UserRegisterFormRequiredDocument", new { area = "RegisterFormSupperAdmin" });
            return View();
        }
        ...
        public IActionResult GetJsonConfig()
        {
            ...
            return Content(System.IO.File.ReadAllText(GlobalConfig.GetJsonConfigFile("RegisterFormSupperAdmin", "UserRegisterFormRequiredDocument")));
        }
