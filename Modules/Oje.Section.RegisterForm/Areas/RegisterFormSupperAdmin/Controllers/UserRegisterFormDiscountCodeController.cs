...
namespace Oje.Section.RegisterForm.Areas.RegisterFormSupperAdmin.Controllers
{
    ...
    [AreaConfig(ModualTitle = "پایه ثبت نام کاربر", Icon = "fa-users", Title = "کد تخفیف (کمپین)")]
    ...
    public class UserRegisterFormDiscountCodeController : Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            ViewBag.ConfigRoute = Url.Action("GetJsonConfig", "UserRegisterFormDiscountCode", new { area = "RegisterFormSupperAdmin" });
            return View();
        }
        ...
        public IActionResult GetJsonConfig()
        {
            ...
            return Content(System.IO.File.ReadAllText(GlobalConfig.GetJsonConfigFile("RegisterFormSupperAdmin", "UserRegisterFormDiscountCode")));
        }
