...
namespace Oje.Section.RegisterForm.Interfaces
{
    public interface IUserFilledRegisterFormService
    {
        ...
        GridResultVM<UserFilledRegisterFormMainGridResultVM> GetList(UserFilledRegisterFormMainGrid searchInput, int? siteSettingId, bool? isPayed = null, bool? isDone = null, long? userId = null);
