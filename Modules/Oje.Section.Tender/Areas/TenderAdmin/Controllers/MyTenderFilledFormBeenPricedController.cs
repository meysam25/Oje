...
namespace Oje.Section.Tender.Areas.TenderAdmin.Controllers
{
    ...
    [AreaConfig(ModualTitle = "سامانه مناقصات", Order = 4, Icon = "fa-funnel-dollar", Title = "مناقصه اعلام قیمت شده")]
    [CustomeAuthorizeFilter]
    public class MyTenderFilledFormBeenPricedController: Controller
    {
        ...
        readonly TenderSelectStatus SelectStatus = TenderSelectStatus.BeenPriceTenderUser;

        public MyTenderFilledFormBeenPricedController
            (
        ...
        [AreaConfig(Title = "مناقصه اعلام قیمت شده", Icon = "fa-file-powerpoint", IsMainMenuItem = true)]
        [HttpGet]
        public IActionResult Index()
        {
            //ViewBag.layer = "_WebLayout";
            ViewBag.Title = "مناقصه اعلام قیمت شده";
            ViewBag.ConfigRoute = Url.Action("GetJsonConfig", "MyTenderFilledFormBeenPriced", new { area = "TenderAdmin" });
            return View();
        }

        [AreaConfig(Title = "تنظیمات صفحه  مناقصه اعلام قیمت شده", Icon = "fa-cog")]
        [HttpPost]
        public IActionResult GetJsonConfig()
        {
            Response.ContentType = "application/json; charset=utf-8";
            return Content(System.IO.File.ReadAllText(GlobalConfig.GetJsonConfigFile("TenderAdmin", "MyTenderFilledFormBeenPriced")));
        }
        ...
        {
            return File(
                    HtmlToPdfBlink.Convert((Request.IsHttps ? "https" : "http") + "://" + Request.Host + Url.Action("PdfDetailes", "MyTenderFilledFormBeenPriced", new { area = "TenderAdmin", id = input.id, isPrint = true }), Request.Cookies),
        ...
        {
            string tempUrl = (Request.IsHttps ? "https" : "http") + "://" + Request.Host + Url.Action("ViewDocument", "MyTenderFilledFormBeenPriced", new { area = "TenderAdmin", tid = id, cId = cId });
            return File(
        ...
        [AreaConfig(Title = "مشاهده  مدارک مناقصه اعلام قیمت شده", Icon = "fa-list-alt")]
        [HttpPost]
        ...
        [AreaConfig(Title = "مشاهده  مناقصه اعلام قیمت شده", Icon = "fa-list-alt")]
        [HttpPost]
