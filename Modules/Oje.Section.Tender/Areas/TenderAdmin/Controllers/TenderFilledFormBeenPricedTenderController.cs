...
namespace Oje.Section.Tender.Areas.TenderAdmin.Controllers
{
    ...
    [AreaConfig(ModualTitle = "مناقصات", Icon = "fa-funnel-dollar", Title = "مناقصات اعلام نرخ شده")]
    [CustomeAuthorizeFilter]
    public class TenderFilledFormBeenPricedTenderController: Controller
    {
        ...
        readonly TenderSelectStatus tenderSelectStatus = TenderSelectStatus.BeenPricedTender;

        public TenderFilledFormBeenPricedTenderController
           (
        ...
        [AreaConfig(Title = "مناقصات اعلام نرخ شده", Icon = "fa-file-powerpoint", IsMainMenuItem = true)]
        [HttpGet]
        public IActionResult Index()
        {
            ViewBag.Title = "مناقصات اعلام نرخ شده";
            ViewBag.ConfigRoute = Url.Action("GetJsonConfig", "TenderFilledFormBeenPricedTender", new { area = "TenderAdmin" });
            return View();
        }
        ...
        public IActionResult GetJsonConfig()
        {
            ...
            return Content(System.IO.File.ReadAllText(GlobalConfig.GetJsonConfigFile("TenderAdmin", "TenderFilledFormBeenPricedTender")));
        }

        [AreaConfig(Title = "دانلود پی دی اف فرم مناقصات اعلام نرخ شده", Icon = "fa-download")]
        [HttpGet]
        public IActionResult DownloadPdf([FromQuery] GlobalLongId input)
        {
            return File(
                    HtmlToPdfBlink.Convert((Request.IsHttps ? "https" : "http") + "://" + Request.Host + Url.Action("PdfDetailes", "TenderFilledFormBeenPricedTender", new { area = "TenderAdmin", id = input.id, isPrint = true }), Request.Cookies),
        ...
        {
            string tempUrl = (Request.IsHttps ? "https" : "http") + "://" + Request.Host + Url.Action("ViewDocument", "TenderFilledFormBeenPricedTender", new { area = "TenderAdmin", tid = id, cId = cId });
            return File(
        ...
        [AreaConfig(Title = "مشاهده لیست مدارک مناقصات اعلام نرخ شده", Icon = "fa-list-alt")]
        [HttpPost]
        ...
        [AreaConfig(Title = "افزودن قیمت جدید برای مناقصات اعلام نرخ شده", Icon = "fa-plus")]
        [HttpPost]
        ...
        [AreaConfig(Title = "مشاهده یک مناقصات اعلام نرخ شده", Icon = "fa-eye")]
        [HttpPost]
        ...
        [AreaConfig(Title = "مشاهده لیست قیمت های مناقصات اعلام نرخ شده", Icon = "fa-list-alt")]
        [HttpPost]
        ...
        [AreaConfig(Title = "خروجی اکسل مبلغ مناقصات اعلام نرخ شده", Icon = "fa-file-excel")]
        [HttpPost]
        ...
        [AreaConfig(Title = "افزودن صدور جدید برای مناقصات اعلام نرخ شده", Icon = "fa-plus")]
        [HttpPost]
        ...
        [AreaConfig(Title = "به روز رسانی صدور مناقصات اعلام نرخ شده", Icon = "fa-pencil")]
        [HttpPost]
        ...
        [AreaConfig(Title = "مشاهده یک مناقصات اعلام نرخ شده صادر شده", Icon = "fa-eye")]
        [HttpPost]
