...
namespace Oje.Section.Tender.Areas.TenderAdmin.Controllers
{
    ...
    public class TenderFilledFormBeenPricedController : Controller
    {
        ...
        readonly TenderSelectStatus SelectStatus = TenderSelectStatus.BeenPriced;

        public TenderFilledFormBeenPricedController
            (
        ...
        public IActionResult Index()
        {
            ...
            ViewBag.ConfigRoute = Url.Action("GetJsonConfig", "TenderFilledFormBeenPriced", new { area = "TenderAdmin" });
            return View();
        }
        ...
        public IActionResult GetJsonConfig()
        {
            ...
            return Content(System.IO.File.ReadAllText(GlobalConfig.GetJsonConfigFile("TenderAdmin", "TenderFilledFormBeenPriced")));
        }
        ...
        {
            return File(
                    HtmlToPdfBlink.Convert((Request.IsHttps ? "https" : "http") + "://" + Request.Host + Url.Action("PdfDetailes", "TenderFilledFormBeenPriced", new { area = "TenderAdmin", id = input.id, isPrint = true }), Request.Cookies),
        ...
        {
            string tempUrl = (Request.IsHttps ? "https" : "http") + "://" + Request.Host + Url.Action("ViewDocument", "TenderFilledFormBeenPriced", new { area = "TenderAdmin", tid = id, cId = cId });
            return File(
