...
namespace Oje.Section.Tender.Areas.TenderAdmin.Controllers
{
    ...
    [AreaConfig(ModualTitle = "مناقصات", Icon = "fa-funnel-dollar", Title = "تنظیمات فرم پیشنهاد")]
    ...
    public class TenderProposalFormJsonConfigController: Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            ViewBag.ConfigRoute = Url.Action("GetJsonConfig", "TenderProposalFormJsonConfig", new { area = "TenderAdmin" });
            return View();
        }
        ...
        public IActionResult GetJsonConfig()
        {
            ...
            return Content(System.IO.File.ReadAllText(GlobalConfig.GetJsonConfigFile("TenderAdmin", "TenderProposalFormJsonConfig")));
        }
