...
namespace Oje.Section.Tender.Areas.TenderAdmin.Controllers
{
    ...
    [AreaConfig(ModualTitle = "مناقصات", Icon = "fa-funnel-dollar", Title = "تنظیمات مناقصه")]
    ...
    public class TenderConfigController: Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            ViewBag.ConfigRoute = Url.Action("GetJsonConfig", "TenderConfig", new { area = "TenderAdmin" });
            return View();
        }
        ...
        public IActionResult GetJsonConfig()
        {
            ...
            return Content(System.IO.File.ReadAllText(GlobalConfig.GetJsonConfigFile("TenderAdmin", "TenderConfig")));
        }
