...
namespace Oje.Section.Tender.Areas.TenderAdmin.Controllers
{
    ...
    [AreaConfig(ModualTitle = "مناقصات", Icon = "fa-funnel-dollar", Title = "دستورالعمل")]
    ...
    public class TenderFileController: Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            ViewBag.ConfigRoute = Url.Action("GetJsonConfig", "TenderFile", new { area = "TenderAdmin" });
            return View();
        }
        ...
        public IActionResult GetJsonConfig()
        {
            ...
            return Content(System.IO.File.ReadAllText(GlobalConfig.GetJsonConfigFile("TenderAdmin", "TenderFile")));
        }
