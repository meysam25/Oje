...
namespace Oje.Section.Tender.Areas.TenderSuperAdmin.Controllers
{
    ...
    [AreaConfig(ModualTitle = "پایه مناقصات", Icon = "fa-funnel-dollar", Title = "افتخارات ما")]
    ...
    public class OurPrideController : Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            ViewBag.ConfigRoute = Url.Action("GetJsonConfig", "OurPride", new { area = "TenderSuperAdmin" });
            return View();
        }
        ...
        public IActionResult GetJsonConfig()
        {
            ...
            return Content(System.IO.File.ReadAllText(GlobalConfig.GetJsonConfigFile("TenderSuperAdmin", "OurPride")));
        }
