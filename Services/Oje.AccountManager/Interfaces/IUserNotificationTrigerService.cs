...
namespace Oje.AccountService.Interfaces
{
    public interface IUserNotificationTrigerService
    {
        ...
        void CreateNotificationForUser(long? userId, UserNotificationType type, List<PPFUserTypes> exteraUserList, long? objectId, string title, int? siteSettingId, string openLink, object exteraParameter, bool isModal);
    }
}
